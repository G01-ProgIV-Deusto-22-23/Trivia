...
P00_DOCUMENT_NUMBER_ARGUMENT (P99_CALL_DEFARG_LIST, 1)
    #define P99_CALL_DEFARG_LIST(NAME, M, ...)                                                                         \
        P99_IF_EQ (0, M)                                                                                               \
        (__VA_ARGS__) (P99_IF_EMPTY (__VA_ARGS__) (P00_DEFARGS (NAME, M, P99_PASTE2 (NAME, _defarg_0) ())              \
...
P00_DOCUMENT_TYPE_ARGUMENT (P99_PROTOTYPE, 2)
    ...
    #define P99_PROTOTYPE(...)                                                                                         \
        ...
        (P00_PROTOTYPE (__VA_ARGS__, void)) (P00_PROTOTYPE (__VA_ARGS__))
#endif
    ...
    #define P99_INSTANTIATE(...)                                                                                       \
        P99_IF_EQ_2 (P99_NARG (__VA_ARGS__))                                                                           \
        (P00_INSTANTIATE (__VA_ARGS__, void)) (P00_INSTANTIATE (__VA_ARGS__))
#endif

#define P00_EXPR_FUNCTION(NAME, X, N)                                                                                  \
    P99_IF_EMPTY (X)                                                                                                   \
    () (inline P99_PASTE3 (NAME, _prototype_, N) P99_PASTE3 (NAME, _defarg_, N) (void) {                               \
...
#define P00_DEFARGS(NAME, N, ...)                                                                                      \
    P00__DEFARGS (                                                                                                     \
        NAME, N,                                                                                                       \
        P99_IF_LT (P99_NARG (__VA_ARGS__), N) (__VA_ARGS__, P99_DUPL (P99_MINUS (N, P99_NARG (__VA_ARGS__)), )) (      \
            __VA_ARGS__                                                                                                \
        )                                                                                                              \
    )
...
#define P00_VAARG(NAMET, X, I)                                                                                         \
    P99_RVAL (P00_VAARG_1 NAMET, P99_IF_EMPTY (X) (P99_PASTE2 (P00_VAARG_0 NAMET, _defarg) ()) (X))
