...
p99_inline p00_tp_glue p00_tp_p2i (void *p, uintptr_t t) {
...
p99_inline void *p00_tp_i2p (p00_tp_glue v) {
    return (void *) (uintptr_t) v;
}

p99_inline uintptr_t p00_tp_i2i (p00_tp_glue v) {
...
struct p00_tp_glue {
    ...
    #define P00_TP_GLUE_INITIALIZER(VAL, TIC)                                                                          \
        { .p00_tag = (TIC), .p00_val = (VAL), }

p99_inline p00_tp_glue p00_tp_p2i (void *p00_val, uintptr_t p00_tag) {
    return (p00_tp_glue) {
        .p00_tag = p00_tag,
        .p00_val = p00_val,
    };
...
p99_inline void *p00_tp_i2p (p00_tp_glue p00_sta) {
    return p00_sta.p00_val;
}

p99_inline uintptr_t p00_tp_i2i (p00_tp_glue p00_sta) {
...
p99_inline uintptr_t p00_tp_tick_get (void) {
    enum {
        p00_bits = sizeof (uintptr_t) * CHAR_BIT / 2,
    };

    register const uintptr_t           p00_mask = (UINTPTR_MAX >> p00_bits);
    register volatile uintptr_t *const p00_ret  = &P99_THREAD_LOCAL (p00_tp_tick);
...
volatile p99_inline p00_tp_glue *p00_tp_glue_init (volatile p00_tp_glue *el, void *p) {
    if (el)
...
struct p99_tp_state {
        ...
        volatile p99_tp *p00_tp;
};

#define P00_TP_INITIALIZER(VAL)                                                                                        \
    { .p00_val = ATOMIC_VAR_INIT (0), .p00_init = (VAL), }

p99_inline bool p00_tp_cmpxchg (
    _Atomic (p00_tp_glue) volatile *const p00_p, volatile p00_tp_glue *const p00_prev, p00_tp_glue p00_new
) {
    bool ret =
        atomic_compare_exchange_weak_explicit (p00_p, p00_prev, p00_new, memory_order_acq_rel, memory_order_consume);
    return ret;
}

p99_inline p00_tp_glue p00_tp_get (register volatile p99_tp *const p00_tp) {
    register p00_tp_glue p00_ret = P99_LIKELY (p00_tp)
 ...
 **/
p99_inline p00_tp_glue p99_tp_xchg (volatile p99_tp *p00_tp, void *p00_val) {
    p00_tp_glue p00_ret = P99_LIKELY (p00_tp) ? atomic_load_explicit (&p00_tp->p00_val, memory_order_consume)
                                              : (p00_tp_glue) P00_TP_GLUE_INITIALIZER ((void *) 0, p00_tp_tick_get ());
 ...
 **/
p99_inline p99_tp_state p99_tp_state_initializer (register volatile p99_tp *const p00_tp, register void *const p00_p) {
    return (p99_tp_state) {
...
p99_inline void *p99_tp_state_get (register volatile p99_tp_state *const p00_state) {
    return P99_LIKELY (p00_state) ? p00_tp_i2p (p00_state->p00_val) : 0;
}

p99_inline void *p99_tp_get (register volatile p99_tp *const p00_tp) {
    return p00_tp_i2p (p00_tp_get (p00_tp));
}

p99_inline void p99_tp_state_set (register volatile p99_tp_state *const p00_state, register void *const p00_p) {
    if (P99_LIKELY (p00_state))
        p00_state->p00_next = p00_tp_p2i (p00_p, p00_tp_i2i (p00_state->p00_next));
}

p99_inline bool p99_tp_state_commit (register volatile p99_tp_state *const p00_state) {
    return P99_LIKELY (p00_state)
               ? p00_tp_cmpxchg (&p00_state->p00_tp->p00_val, &p00_state->p00_val, p00_state->p00_next)
               : false;
}

p99_inline bool p99_tp_state_check (register volatile p99_tp_state *const p00_state) {
    return P99_LIKELY (p00_state)
...
#define P99_TP_INITIALIZER(VAL)                                                                                        \
    { .p00_tp = P00_TP_INITIALIZER (VAL), }

p99_inline void p00_tp_init (register volatile p99_tp *const p00_el, register void *const p00_val) {
...
#define P99_TP_STATE_INITIALIZER(TP, P)                                                                                \
    p99_extension ({                                                                                                   \
        ...
        register P99_TP_TYPE_STATE (p00_tp) const p00_r = {                                                            \
            .p00_st = p00_tp ? p99_tp_state_initializer (&p00_tp->p00_tp, p00_p) : (p99_tp_state) P99_INIT,            \
        };                                                                                                             \
        p00_r;                                                                                                         \
    })
...
#define P99_TP_XCHG(TP, VAL)                                                                                             \
    p99_extension ({                                                                                                     \
        ...
        register P99_TP_TYPE (p00_tp) *const p00_r   = p00_tp ? p00_tp_i2p (p99_tp_xchg (&p00_tp->p00_tp, p00_val)) : 0; \
        p00_r;                                                                                                           \
    })
...
#define P99_TP_GET(TP)                                                                                                 \
    p99_extension ({                                                                                                   \
        ...
        /* base type, and that the return can't be used as lvalue */                                                   \
        register P99_TP_TYPE (p00_tp) *const p00_r = p00_tp ? p99_tp_get (&p00_tp->p00_tp) : 0;                        \
        p00_r;                                                                                                         \
    })
...
#define P99_TP_STATE_GET(TPS)                                                                                          \
    p99_extension ({                                                                                                   \
        ...
        /* ensure that pointer that is returned is converted to the */                                                 \
        /* base type, and that the return can't be used as lvalue */                                                   \
        register P99_TP_STATE_TYPE (p00_tps) *const p00_r = p00_tps ? p99_tp_state_get (&p00_tps->p00_st) : 0;         \
        p00_r;                                                                                                         \
    })
...
#define P99_TP_STATE_COMMIT(TPS)                                                                                       \
    p99_extension ({                                                                                                   \
        P99_MACRO_VAR (p00_tps, (TPS));                                                                                \
        register bool const p00_r = p00_tps ? p99_tp_state_commit (&p00_tps->p00_st) : false;                          \
        p00_r;                                                                                                         \
    })
...
#define P99_TP_STATE_CHECK(TPS)                                                                                        \
    p99_extension ({                                                                                                   \
        P99_MACRO_VAR (p00_tps, (TPS));                                                                                \
        register bool const p00_r = p00_tps ? p99_tp_state_check (&(p00_tps)->p00_st) : false;                         \
        p00_r;                                                                                                         \
    })
...
#define P99_REF_ACCOUNT(REF)                                                                                           \
    p99_extension ({                                                                                                   \
        ...
        if (p00_r)                                                                                                     \
            atomic_fetch_add_explicit (&p00_r->p99_cnt, 1, memory_order_acq_rel);                                      \
        p00_r;                                                                                                         \
    })
...
#define P99_REF_DISCOUNT(REF, DELETE)                                                                                  \
    p99_extension ({                                                                                                   \
        P99_MACRO_VAR (p00_ref, (REF));                                                                                \
        register void (*const p00_d) (__typeof__ (*p00_ref) const *) = (DELETE);                                       \
        /* ensure that the pointer is converted to the */                                                              \
        /* base type, and that the return can't be used as lvalue */                                                   \
        register __typeof__ (*p00_ref) *const p00_r                  = p00_ref;                                        \
...
#define P99_TP_REF_INITIALIZER(VAL, ACCOUNT)                                                                           \
    P99_TP_INITIALIZER (P99_GENERIC_NULLPTR_CONSTANT (VAL, (void *) 0, ACCOUNT (VAL)))
...
#define P99_TP_REF_INIT(...)                                                                                           \
    ...
    (P00_TP_REF_INIT1 (__VA_ARGS__)) (P00_TP_REF_INIT2 (__VA_ARGS__))
...
#define P99_TP_REF_DEFINE(T)                                                                                              \
    ...
    P99_INSTANTIATE (T *, P99_PASTE2 (T, _ref_mv), P99_PASTE2 (T, _ref) volatile *, P99_PASTE2 (T, _ref) volatile *);     \
    P99_INSTANTIATE (T *, P99_PASTE2 (T, _ref_assign), P99_PASTE2 (T, _ref) volatile *, P99_PASTE2 (T, _ref) volatile *); \
...
P00_DOCUMENT_TYPE_ARGUMENT (P99_TP_REF_FUNCTIONS, 0)
    #define P99_TP_REF_FUNCTIONS(T)                                                                                    \
        ...
        /** \remark If ::P99_CALL_DEFARG is used to provide defaults for the arguments, the second argument defaults   \
         * to \c 0 if omitted **/                                                                                      \
        /** \related T ## _ref **/                                                                                     \
        ...
        /** \return the previous pointer before replacement **/                                                        \
        /** \related T ## _ref **/                                                                                     \
        inline T   *P99_PASTE2 (T, _ref_mv) (P99_PASTE2 (T, _ref) volatile *, P99_PASTE2 (T, _ref) volatile *) {}      \
        /** \brief replace the value of a reference by that of the second argument **/                                 \
        /** \remark the value of the second argument remains untouched **/                                             \
        /** \return the previous pointer before replacement **/                                                        \
        /** \related T ## _ref **/                                                                                     \
        inline T   *P99_PASTE2 (T, _ref_assign) (P99_PASTE2 (T, _ref) volatile *, P99_PASTE2 (T, _ref) volatile *) {}  \
...
P00_DOCUMENT_TYPE_ARGUMENT (P99_TP_REF_FUNCTIONS, 0)
    #define P99_TP_REF_FUNCTIONS(T)                                                                                    \
                                                                                                                       \
        inline T *P99_PASTE2 (T, _account) (T * p00_el) { return P99_REF_ACCOUNT (p00_el); }                           \
                                                                                                                       \
        inline T *P99_PASTE2 (T, _discount) (T * p00_el) {                                                             \
            return P99_REF_DISCOUNT (p00_el, P99_PASTE2 (T, _delete));                                                 \
        }                                                                                                              \
                                                                                                                       \
        inline P99_PASTE2 (T, _ref) * P99_PASTE2 (T, _ref_init) (P99_PASTE2 (T, _ref) * el, T * p00_v) {               \
            return P99_TP_REF_INIT (el, p00_v);                                                                        \
        }                                                                                                              \
                                                                                                                       \
        inline T *P99_PASTE2 (T, _ref_init_defarg_1) (void) { return 0; }                                              \
                                                                                                                       \
        inline T *P99_PASTE2 (T, _ref_get) (P99_PASTE2 (T, _ref) volatile * p00_ref) { return P99_TP_GET (p00_ref); }  \
                                                                                                                       \
        inline T *P99_PASTE2 (T, _ref_replace) (P99_PASTE2 (T, _ref) volatile * p00_tar, T * p00_sou) {                \
            return P99_TP_REF_REPLACE (p00_tar, p00_sou, P99_PASTE2 (T, _delete));                                     \
        }                                                                                                              \
                                                                                                                       \
        inline T *P99_PASTE2 (T, _ref_mv) (                                                                            \
            P99_PASTE2 (T, _ref) volatile * p00_tar, P99_PASTE2 (T, _ref) volatile * p00_sou                           \
        ) {                                                                                                            \
            return P99_TP_REF_MV (p00_tar, p00_sou, P99_PASTE2 (T, _delete));                                          \
        }                                                                                                              \
                                                                                                                       \
        inline T *P99_PASTE2 (T, _ref_assign) (                                                                        \
            P99_PASTE2 (T, _ref) volatile * p00_tar, P99_PASTE2 (T, _ref) volatile * p00_sou                           \
        ) {                                                                                                            \
            return P99_TP_REF_REPLACE (p00_tar, P99_TP_GET (p00_sou), P99_PASTE2 (T, _delete));                        \
        }                                                                                                              \
                                                                                                                       \
        inline void P99_PASTE2 (T, _ref_destroy) (P99_PASTE2 (T, _ref) * p00_ref) {                                    \
