...
p99_inline int p00_strerror (int p00_errname, size_t p00_maxsize, char p00_s [p00_maxsize]) {
...
p99_inline const char *p00_strerror_r (int p00_errname, size_t p00_maxsize, char p00_s [p00_maxsize]) {
...
p99_inline size_t strnlen_s (const char *p00_s, size_t p00_maxsize) {
    ...
    if (p00_s && p00_maxsize) {
        const char *p00_pos = memchr (p00_s, 0, p00_maxsize);
        if (p00_pos)
...
p99_inline const char *p00_strerror_s (char *p00_s, rsize_t p00_maxsize, errno_t p00_errnum) {
...
p99_inline void
    p00_constraint_report (errno_t p00_cond, const char *p00_file, const char *p00_context, const char *p00_info) {
    ...
    {
        const char *const p00_errname = p99_errno_getname (p00_cond);
        if (p00_errname) {
...
p99_inline void p99_report_handler (const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err) {
    P99_UNUSED (p00_ptr);
    p00_constraint_report (p00_err, 0, 0, p00_msg);
}

p99_inline void p99_ignore_handler (const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err) {
    P99_UNUSED (p00_msg);
    P99_UNUSED (p00_ptr);
    P99_UNUSED (p00_err);
}

noreturn p99_inline void p99_abort_handler (const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err) {
    P99_UNUSED (p00_ptr);
    p00_constraint_report (p00_err, 0, 0, p00_msg);
...
noreturn p99_inline void p99_exit_handler (const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err) {
    P99_UNUSED (p00_ptr);
    P99_UNUSED (p00_err);
    p00_constraint_report (p00_err, 0, 0, p00_msg);
    fputs ("runtime constraint violation: ", stderr);
...
noreturn void exit_handler_s (const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err) {
...
noreturn void abort_handler_s (const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err) {
    p99_abort_handler (p00_msg, p00_ptr, p00_err);
}

p99_inline constraint_handler_t set_constraint_handler_s (constraint_handler_t p00_hand) {
    if (!p00_hand)
...
p99_inline errno_t
    p00_constraint_call (errno_t p00_cond, const char *p00_file, const char *p00_context, const char *p00_info) {
    if (p00_cond) {
        if (p00_file)
...
p99_inline errno_t p00_memcpy_s (
    _Bool p00_overlap, void *restrict p00_s1, rsize_t p00_s1max, const void *restrict p00_s2, rsize_t p00_n
) {
    errno_t p00_ret = 0;
    if (!p00_s1) {
        p00_ret = EINVAL;
    ...
    if (!p00_overlap) {
        const unsigned char *p00_c1 = p00_s1;
        const unsigned char *p00_c2 = p00_s2;
        /* Strictly speaking all this range check is UB if the regions don't
           overlap. */
        if ((p00_c1 <= p00_c2 && p00_c2 < (p00_c1 + p00_s1max)) || (p00_c2 <= p00_c1 && p00_c1 < (p00_c2 + p00_n))) {
            p00_ret = EINVAL;
            goto P00_ERR;
        }
    ...
    return p00_ret;
        ...
        #define memcpy_s(S1, S1MAX, S2, N)                                                                             \
            P99_CONSTRAINT_TRIGGER (                                                                                   \
                p00_memcpy_s (false, (S1), (S1MAX), (S2), (N)), "memcpy_s runtime constraint violation"                \
            )
        /** @ingroup C11_library **/
        #define memmove_s(S1, S1MAX, S2, N)                                                                            \
            P99_CONSTRAINT_TRIGGER (                                                                                   \
                p00_memcpy_s (true, (S1), (S1MAX), (S2), (N)), "memmove_s runtime constraint violation"                \
            )

p99_inline errno_t p00_strcpy_s (void *restrict p00_s1, rsize_t p00_s1max, const void *restrict p00_s2) {
    ...
    return p00_memcpy_s (false, p00_s1, p00_s1max, p00_s2, p00_len);
        ...
        #define strcpy_s(S1, S1MAX, S2)                                                                                \
            P99_CONSTRAINT_TRIGGER (p00_strcpy_s ((S1), (S1MAX), (S2)), "strcpy_s runtime constraint violation")
...
p99_inline errno_t
    ...
    return p00_ret;
        ...
        #define strncpy_s(S1, S1MAX, S2, N)                                                                            \
            P99_CONSTRAINT_TRIGGER (p00_strncpy_s ((S1), (S1MAX), (S2), (N)), "strncpy_s runtime constraint violation")

p99_inline errno_t p00_strcat_s (char *restrict p00_s1, rsize_t p00_s1max, const char *restrict p00_s2) {
    if (!p00_s1 || !p00_s1max || p00_s1max > RSIZE_MAX)
    ...
    return p00_ret;
        ...
        #define strcat_s(S1, S1MAX, S2)                                                                                \
            P99_CONSTRAINT_TRIGGER (p00_strcat_s ((S1), (S1MAX), (S2)), "strcat_s runtime constraint violation")
...
p99_inline errno_t
    ...
    return p00_ret;
        ...
        #define strncat_s(S1, S1MAX, S2, N)                                                                            \
            P99_CONSTRAINT_TRIGGER (p00_strncat_s ((S1), (S1MAX), (S2), (N)), "strncat_s runtime constraint violation")

p99_inline void *p00_bsearch_s (
    const char *p00_file, const char *p00_context, const void *p00_key, const void *p00_base, rsize_t p00_nmemb,
    rsize_t p00_size, int (*p00_compar) (const void *, const void *, void *), void *p00_ctx
) {
    if (p00_nmemb) {
        if (p00_nmemb > RSIZE_MAX || p00_size > RSIZE_MAX) {
            ...
            register const unsigned char (*p00_dbase) [p00_size] = (void *) p00_base;
...
p99_inline errno_t p00_getenv_s (
    const char *p00_file, const char *p00_context, size_t *restrict p00_len, char *restrict p00_value,
    rsize_t p00_maxsize, const char *restrict p00_name
) {
    errno_t p00_ret = 0;
    size_t  p00_le  = 0;
    if (p00_maxsize > RSIZE_MAX) {
        ...
        const char *const p00_found = getenv (p00_name);
        if (p00_found) {
...
p99_inline errno_t
    p00_tmpfile_s (const char *p00_file, const char *p00_context, FILE *restrict *restrict p00_streamptr) {
    errno_t p00_ret = 0;
    if (!p00_streamptr) {
        p00_ret = EINVAL;
    } else {
...
p99_inline errno_t p00_tmpnam_s (const char *p00_file, const char *p00_context, char *p00_s, rsize_t p00_maxsize) {
    errno_t p00_ret = 0;
    if (p00_maxsize > RSIZE_MAX) {
        p00_ret = EDOM;
    } else if (!p00_s) {
...
p99_inline char *p00_gets_s (const char *p00_file, const char *p00_context, char *p00_s, rsize_t p00_n) {
    errno_t p00_err = 0;
    char   *p00_ret = 0;
    if (!p00_s) {
        p00_err = EINVAL;
...
P99_PURE_FUNCTION
p99_inline bool p00_isin0 (char p00_c, rsize_t p00_s2l, const uint8_t p00_s2 [const restrict p00_s2l]) {
    if (p00_c)
...
P99_PURE_FUNCTION
p99_inline rsize_t p99_span (
    rsize_t p00_s1l, uint8_t p00_s1 [const restrict p00_s1l], rsize_t p00_s2l,
    const uint8_t p00_s2 [const restrict p00_s2l]
) {
...
p99_inline uint8_t *p00_strtok_inner (
    rsize_t *restrict p00_s1max, uint8_t p00_ret0 [restrict (*p00_s1max)], rsize_t p00_s2max,
    const uint8_t p00_s2 [const restrict p00_s2max], uint8_t **restrict p00_ptr
) {
    ...
    register const size_t p00_l   = p99_span (*p00_s1max, p00_ret, p00_s2max, p00_s2);
    if (p00_l < *p00_s1max) {
        *p00_s1max -= p00_l;
        p00_ret    += p00_l;

        register const size_t p00_k = p00_cskip (*p00_s1max, p00_ret, p00_s2max, p00_s2);
...
p99_inline char *p00_strtok_s (
    const char *p00_file, const char *p00_context, rsize_t *restrict p00_s1max, uint8_t p00_s1 [restrict (*p00_s1max)],
    rsize_t p00_s2max, const uint8_t p00_s2 [const restrict p00_s2max], uint8_t **restrict p00_ptr
) {
    errno_t  p00_err = 0;
    uint8_t *p00_ret = 0;
    ...
    return (char *) p00_ret;
        ...
        #define P00_STRSIZE(S)                                                                                         \
            P99_GENERIC (                                                                                              \
                S, sizeof (S), (char *, strlen (S) + 1), (char const *, strlen (S) + 1),                               \
                (char volatile *, strlen (S) + 1), (char volatile const *, strlen (S) + 1),                            \
                (char *restrict, strlen (S) + 1), (char const *restrict, strlen (S) + 1),                              \
                (char volatile *restrict, strlen (S) + 1), (char volatile const *restrict, strlen (S) + 1)             \
            )

        /** @ingroup C11_library **/
        #define strtok_s(S1, S1MAX, S2, PTR)                                                                           \
            p00_strtok_s (                                                                                             \
                P99_STRINGIFY (__LINE__), __func__, S1MAX, (uint8_t *restrict) (S1), P00_STRSIZE (S2),                 \
                (uint8_t const *restrict) (S2), (uint8_t **) PTR                                                       \
            )

        #define P00_SPAN_DECLARE(NAME, SET)                                                                            \
            P99_PURE_FUNCTION                                                                                          \
            p99_inline rsize_t P99_PASTE2 (p99_span_, NAME) (                                                          \
                rsize_t p00_s1l, uint8_t p00_s1 [const restrict p00_s1l]                                               \
            ) {                                                                                                        \
...
p99_inline bool p00_tm_valid (struct const tm *p00_tm) {
...
p99_inline errno_t p00_asctime_s (
    const char *p00_file, const char *p00_context, char *p00_s, rsize_t p00_maxsize, const struct tm *p00_tptr
) {
    errno_t p00_ret = 0;
    if (P99_UNLIKELY (p00_maxsize < 26 || p00_maxsize > RSIZE_MAX)) {
        ...
        if (1000 <= p00_val && p00_val <= 9999) {
            ...
            const char p00_wday [7][3] = { "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };
            const char p00_mon [12][3] = { "Jan", "Feb", "Mar", "Apr", "May", "Jun",
                                           "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
            snprintf (
                p00_s, p00_maxsize, "%.3s %.3s %2d %.2d:%.2d:%.2d %.4s\n", p00_wday [p00_tptr->tm_wday],
                p00_mon [p00_tptr->tm_mon], p00_tptr->tm_mday, p00_tptr->tm_hour, p00_tptr->tm_min, p00_tptr->tm_sec,
                p00_year
            );
        } else {
            p00_ret = EDOM;
...
p99_inline struct tm *
    p00_localtime_s (const char *p00_file, const char *p00_context, const time_t *restrict p00_t, struct tm *p00_tptr) {
    struct tm *p00_ret = 0;
    errno_t    p00_err = 0;
...
p99_inline struct tm *
    p00_gmtime_s (const char *p00_file, const char *p00_context, const time_t *restrict p00_t, struct tm *p00_tptr) {
    struct tm *p00_ret = 0;
    errno_t    p00_err = 0;
    if (P99_UNLIKELY (!p00_t || !p00_tptr)) {
        p00_err = EINVAL;
