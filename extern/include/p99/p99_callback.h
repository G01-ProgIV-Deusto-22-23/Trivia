...
p99_inline p99_callback_el *p99_callback_el_init (
    p99_callback_el *p00_obj, p99_callback_voidptr_func *p00_voidptr_func, p99_callback_void_func *p00_void_func,
    void *p00_arg
) {
    if (p00_obj) {
        if (p00_voidptr_func)
...
#define p99_callback_el_init_1(FUNC)                                                                                   \
    P99_GENERIC (                                                                                                      \
        (&*FUNC), , (p99_callback_voidptr_func *, (p99_callback_voidptr_func *) (FUNC)),                               \
        (p99_callback_void_func *, (p99_callback_voidptr_func *) 0)                                                    \
    )

#define p99_callback_el_init_2(FUNC)                                                                                   \
    P99_GENERIC (                                                                                                      \
        (&*FUNC), , (p99_callback_void_func *, (p99_callback_void_func *) (FUNC)),                                     \
...
#define p99_callback_el_init(...)                                                                                      \
    ...
    (p99_callback_el_init_ (__VA_ARGS__, 0)) (p99_callback_el_init_ (__VA_ARGS__))

p99_inline void p99_callback_el_call (const p99_callback_el p00_el) {
    if (p00_el.p00_voidptr_func)
        p00_el.p00_voidptr_func (p00_el.p00_void.p00_arg);
    else if (p00_el.p00_void.p00_void_func)
        p00_el.p00_void.p00_void_func ();
}

p99_inline p99_callback_el *p00_callback_push (p99_callback_stack *p00_l, p99_callback_el *p00_el) {
    if (p00_el)
