 ...
 **/
    ...
    #define P00_INIT_FUNCTION(NR)                                                                                      \
        P99_IF_EMPTY (NR) (P99_PASTE2 (p00_init_function_, P00_INIT_NR)) (P99_PASTE2 (p00_init_function_, NR))

    #define P00_HAVE_INIT_FUNCTION(NR)                                                                                 \
        P99_IF_EMPTY (NR) (P99_PASTE2 (p00_have_init_function_, P00_INIT_NR)) (P99_PASTE2 (p00_have_init_function_, NR))
...
P99_FOR (, P99_MAX_NUMBER, P00_SEP, P00_INIT_FUNC_VAR_S, P99_REP (P99_MAX_NUMBER, ));
    ...
    #define P00_INIT_TRIGGER_FUNCTION_1(_0, _1, I)                                                                     \
        do {                                                                                                           \
            if (P00_HAVE_INIT_FUNCTION (I))                                                                            \
                p99_callback_el_call (P00_INIT_FUNCTION (I));                                                          \
        } while (false)
    ...
    #else
        #define P99_INIT_FUNCTION_DECLARE(...)                                                                         \
            P99_IF_EQ (P99_NARG (__VA_ARGS__), 2)                                                                      \
            (P00_INIT_FUNCTION_ (__VA_ARGS__)) (P00_INIT_FUNCTION_ (__VA_ARGS__, ))
    #endif
...
= {                                                             \
  ...
  .p00_void = {                                                 \
    ...
    #else
        #define P99_INIT_VARIABLE(...)                                                                                 \
            P99_IF_EQ (P99_NARG (__VA_ARGS__), 3) (P00_INIT_VARIABLE (__VA_ARGS__)) (P00_INIT_VARIABLE (__VA_ARGS__, ))
    #endif
...
P99_CONST_FUNCTION
p99_inline void p00_init_func_p99_init_main (int *p00_argc, char ***p00_argv) {
    P99_UNUSED (p00_argc);
    P99_UNUSED (p00_argv);
}
