...
P00_C99_DEFARG_DOCU (wcstol, long, const wchar_t *p00_nptr, wchar_t **p00_eptr, int p00_base)
...
P00_C99_DEFARG_DOCU (wcstoll, long long, const wchar_t *p00_nptr, wchar_t **p00_eptr, int p00_base)
...
P00_C99_DEFARG_DOCU (wcstoimax, intmax_t, const wchar_t *p00_nptr, wchar_t **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (wcstoul, unsigned long, const wchar_t *p00_nptr, wchar_t **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (wcstoull, unsigned long long, const wchar_t *p00_nptr, wchar_t **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (wcstoumax, uintmax_t, const wchar_t *p00_nptr, wchar_t **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (wcstof, float, const wchar_t *p00_nptr, wchar_t **p00_eptr)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
#define wcstof(...)       P99_CALL_DEFARG (wcstof, 2, __VA_ARGS__)
#define wcstof_defarg_1() 0

P00_C99_DEFARG_DOCU (wcstod, double, const wchar_t *p00_nptr, wchar_t **p00_eptr)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
#define wcstod(...)       P99_CALL_DEFARG (wcstod, 2, __VA_ARGS__)
#define wcstod_defarg_1() 0

P00_C99_DEFARG_DOCU (wcstold, long double, const wchar_t *p00_nptr, wchar_t **p00_eptr)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
#define wcstold(...)       P99_CALL_DEFARG (wcstold, 2, __VA_ARGS__)
#define wcstold_defarg_1() 0

P00_C99_DEFARG_DOCU (strtol, long, const char *p00_nptr, char **p00_eptr, int p00_base)
...
P00_C99_DEFARG_DOCU (strtoll, long long, const char *p00_nptr, char **p00_eptr, int p00_base)
...
P00_C99_DEFARG_DOCU (strtoimax, intmax_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (strtoul, unsigned long, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (strtoull, unsigned long long, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (strtoumax, uintmax_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (strtof, float, const char *p00_nptr, char **p00_eptr)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
#define strtof(...)       P99_CALL_DEFARG (strtof, 2, __VA_ARGS__)
#define strtof_defarg_1() 0

P00_C99_DEFARG_DOCU (strtod, double, const char *p00_nptr, char **p00_eptr)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
#define strtod(...)       P99_CALL_DEFARG (strtod, 2, __VA_ARGS__)
#define strtod_defarg_1() 0

P00_C99_DEFARG_DOCU (strtold, long double, const char *p00_nptr, char **p00_eptr)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
...
#define P00_DECLARE_STRTO(SUFF)                                                                                        \
    ...
    p99_inline P99_BUILTIN_TYPE (SUFF)                                                                                 \
        ...
        if ((p00_ret > P99_BUILTIN_MAX (SUFF) || p00_ret < P99_BUILTIN_MIN (SUFF)) && (!errno))                        \
            errno = ERANGE;                                                                                            \
        if (p00_ret > P99_BUILTIN_MAX (SUFF))                                                                          \
            p00_ret = P99_BUILTIN_MAX (SUFF);                                                                          \
        if (p00_ret < P99_BUILTIN_MIN (SUFF))                                                                          \
            p00_ret = P99_BUILTIN_MIN (SUFF);                                                                          \
        return p00_ret;                                                                                                \
    }                                                                                                                  \
 ...
 **  - flexible p00_base, namely octal, decimal or hexadecimal conversion
 **/
P00_C99_DEFARG_DOCU (p99_strto, signed, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtoc, char, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtohh, signed char, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtouhh, unsigned char, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtoh, signed short, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtouh, unsigned short, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
 ...
 **  - flexible p00_base, namely octal, decimal or hexadecimal conversion
 **/
P00_C99_DEFARG_DOCU (p99_strtou, unsinged, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtoi8, int_least8_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtot, ptrdiff_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtouz, size_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtou8, uint_least8_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtoi16, int_least16_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtou16, uint_least16_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtoi32, int_least32_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtou32, uint_least32_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtoi64, int_least64_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (p99_strtou64, uint_least64_t, const char *p00_nptr, char **p00_eptr, int p00_base)
/*! @param p00_nptr is required */
/*! @param p00_eptr defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
