...
typedef int p00_getopt_process_type (void *, const char *);

struct p00_getopt {
        void *const                    p00_o;
        p00_getopt_process_type *const p00_f;
        const char *const              p00_a;
        const char *const              p00_d;
        const char *const              p00_t;
        const char *const              p00_n;
        const char *const              p00_v;
};
...
int p00_getopt_comp (const void *p00_a, const void *p00_b, void *p00_context) {
    register struct const p00_getopt *const *const p00_A = p00_a;
    register struct const p00_getopt *const *const p00_B = p00_b;
...
int p00_getopt_subcomp (const void *p00_a, const void *p00_b, void *p00_context) {
    register struct const p00_getopt *const *const p00_A = p00_a;
    register struct const p00_getopt *const *const p00_B = p00_b;
    if (p00_A && (*p00_A) && (*p00_A)->p00_a)
        if (p00_B && (*p00_B) && (*p00_B)->p00_a) {
...
#define P00_GETOPT_SIGNED(T)                                                                                           \
    static_inline int P00_GETOPT_PROCESS (T) (void *p00_o, char const *p00_c) {                                        \
        T *p00_O = p00_o;                                                                                              \
        if (p00_c && p00_c [0]) {                                                                                      \
            char *endptr = 0;                                                                                          \
...
P99_SER (P00_GETOPT_SIGNED, schar, short, int, long, llong)
...
P99_SER (P00_GETOPT_UNSIGNED, uchar, ushort, unsigned, ulong, ullong)

static_inline int P00_GETOPT_PROCESS (char) (void *p00_o, const char *p00_c) {
    char *p00_O = p00_o;
    if (p00_c && p00_c [0]) {
        *p00_O = p00_c [0];
        return 1;
...
static_inline int P00_GETOPT_PROCESS (_Bool) (void *p00_o, const char *p00_c) {
    P99_UNUSED (p00_c);
    bool *p00_O = p00_o;
    *p00_O      = !*p00_O;
    return 0;
...
static_inline int P00_GETOPT_PROCESS (char_cptr) (void *p00_o, const char *p00_c) {
    const char **p00_O = p00_o;
    if (p00_c) {
...
P99_SER (P00_GETOPT_FLOAT, float, double, ldouble)
...
#define P00_GETOPT_DECLARE(CHAR, T, TS, DEFS, NAME, DEF, ALIAS, DOC, ...)                                              \
    ...
    P99_TENTATIVE_DEF (struct p00_getopt const *const, P00_GETOPT_CHAR (CHAR)) = &(struct p00_getopt const) {          \
        .p00_o = &(NAME), .p00_f = P99_GENERIC (NAME, 0, __VA_ARGS__), .p00_a = (ALIAS), .p00_d = (DOC), .p00_t = TS,  \
        .p00_n = #NAME, .p00_v = DEFS,                                                                                 \
    }
...
P00_DOCUMENT_IDENTIFIER_ARGUMENT (P99_GETOPT_DECLARE, 2)
    #define P99_GETOPT_DECLARE(CHAR, T, ...)                                                                           \
        P00_GETOPT_DECLARE_ (                                                                                          \
            _p00##CHAR, T, #T, #__VA_ARGS__,                                                                           \
            P99_IF_LT (P99_NARG (__VA_ARGS__), 2) (__VA_ARGS__, 0, 0, 0) (P99_IF_LT (P99_NARG (__VA_ARGS__), 3) (      \
                __VA_ARGS__, 0, 0                                                                                      \
            ) (P99_IF_LT (P99_NARG (__VA_ARGS__), 4) (__VA_ARGS__, 0) (__VA_ARGS__))),                                 \
...
P00_DOCUMENT_IDENTIFIER_ARGUMENT (P99_GETOPT_DEFINE, 2)
    #define P99_GETOPT_DEFINE(CHAR, T, ...)                                                                            \
        ...
        ) (P99_IF_LT (P99_NARG (__VA_ARGS__), 3) (P00_GETOPT_DEFINE (CHAR, T, __VA_ARGS__, 0, 0)                       \
        ) (P99_IF_LT (P99_NARG (__VA_ARGS__), 4) (P00_GETOPT_DEFINE (CHAR, T, __VA_ARGS__, 0)                          \
...
#define P00_GETOPT_CHARS                                                                                               \
    _p00A, _p00B, _p00C, _p00D, _p00E, _p00F, _p00G, _p00H, _p00I, _p00J, _p00K, _p00L, _p00M, _p00N, _p00O, _p00P,    \
        _p00Q, _p00R, _p00S, _p00T, _p00U, _p00V, _p00W, _p00X, _p00Y, _p00Z, _p00a, _p00b, _p00c, _p00d, _p00e,       \
        _p00f, _p00g, _p00h, _p00i, _p00j, _p00k, _p00l, _p00m, _p00n, _p00o, _p00p, _p00q, _p00r, _p00s, _p00t,       \
        _p00u, _p00v, _p00w, _p00x, _p00y, _p00z, _p000, _p001, _p002, _p003, _p004, _p005, _p006, _p007, _p008,       \
        _p009, _p00_, _p00AMPERSAND, _p00APOSTROPHE, _p00ASTERISK, _p00AT, _p00BACKSLASH, _p00BAR, _p00BRACELEFT,      \
        _p00BRACERIGHT, _p00BRACKETLEFT, _p00BRACKETRIGHT, _p00CARRET, _p00COLON, _p00COMMA, _p00DOLLAR, _p00EQUAL,    \
        _p00EXLAM, _p00GRAVE, _p00GREATER, _p00HASH, _p00HELP, _p00LESS, _p00PARENLEFT, _p00PARENRIGHT, _p00PERCENT,   \
        _p00PERIOD, _p00PLUS, _p00QUOTEDBL, _p00SEMICOLON, _p00SLASH, _p00TILDE
...
static_inline int P00_GETOPT_PROCESS (help) (void *p00_o, const char *p00_c);
...
P99_TENTATIVE_DEC (const char *, p00_getopt_progname);
...
/* Split the "va_arg" argument of the P99_GETOPT macros into the name
   ...
   expanded it. */
p99_inline void p00_getopt_help_split (size_t p00_len, char p00_buf [p00_len], const char **p00_n, const char **p00_v) {
    size_t p00_pos = 0;
...
p99_inline void p00_getopt_help_count_ (
    bool p00_set, enum p99_getopt_enum p00_c, struct const p00_getopt *p00_pc, struct const p00_getopt *p00_help,
    int p00_ns [4]
) {
    register struct const p00_getopt *const p00_p =
        (p00_set ? p00_pc : (((p00_c != p99_getopt_enum_p00h) && (p00_c != p99_getopt_enum_p00HELP)) ? 0 : p00_help));
    if (p00_p) {
        if (p00_p->p00_a)
            p00_ns [0] = P99_GEN_MAX (p00_ns [0], strlen (p00_p->p00_a));
        if (p00_p->p00_t)
            p00_ns [1] = P99_GEN_MAX (p00_ns [1], strlen (p00_p->p00_t));
        const char  *p00_n   = p00_p->p00_n;
        const char  *p00_v   = "";
        const size_t p00_len = 1 + (p00_p->p00_v ? strlen (p00_p->p00_v) : 0);
        ...
        if (p00_n)
            p00_ns [2] = P99_GEN_MAX (p00_ns [2], strlen (p00_n));
        if (p00_v)
            p00_ns [3] = P99_GEN_MAX (p00_ns [3], strlen (p00_v));
    }
}

#define P00_GETOPT_HELP_COUNT_(CHAR)                                                                                   \
    p00_getopt_help_count_ (                                                                                           \
        p00_getopt_bool##CHAR, p99_getopt_enum##CHAR, P00_GETOPT_CHAR (CHAR), p00_getopt_help, p00_ns                  \
    )

#define P00_GETOPT_HELP_COUNT(...) P99_SEP (P00_GETOPT_HELP_COUNT_, __VA_ARGS__)

p99_inline void p00_getopt_help_ (
    bool p00_set, enum p99_getopt_enum p00_c, struct const p00_getopt *p00_pc, struct const p00_getopt *p00_help,
    const int p00_ns [4]
) {
    register struct const p00_getopt *const p00_p =
        (p00_set ? p00_pc : (((p00_c != p99_getopt_enum_p00h) && (p00_c != p99_getopt_enum_p00HELP)) ? 0 : p00_help));
    if (p00_p) {
        const char *const p00_d   = p00_p->p00_d ? p00_p->p00_d : "(not documented)";
        const char *const p00_t   = p00_p->p00_t ? p00_p->p00_t : "";
        const char       *p00_n   = "";
        const char       *p00_v   = "";
        const size_t      p00_len = 1 + (p00_p->p00_v ? strlen (p00_p->p00_v) : 0);
        char              p00_buf [p00_len];
        ...
        if (p00_p->p00_a)
            fprintf (
                stderr, "   -%c  --%-*s%-*s%-*s%-*s\t%s\n", p00_c, p00_ns [0] + 2, p00_p->p00_a, p00_ns [1] + 2, p00_t,
                p00_ns [2] + 2, p00_n, p00_ns [3] + 2, p00_v, p00_d
            );
        else
            fprintf (
                stderr, "   -%c    %-*s%-*s%-*s%-*s \t%s\n", p00_c, p00_ns [0] + 2, "", p00_ns [1] + 2, p00_t,
                p00_ns [2] + 2, p00_n, p00_ns [3] + 2, p00_v, p00_d
            );
    }
}
...
#define P00_GETOPT_HELP_(CHAR)                                                                                         \
    p00_getopt_help_ (p00_getopt_bool##CHAR, p99_getopt_enum##CHAR, P00_GETOPT_CHAR (CHAR), p00_getopt_help, p00_ns)

#define P00_GETOPT_HELP(...) P99_SEP (P00_GETOPT_HELP_, __VA_ARGS__)

P99_TENTATIVE_DEC (const char *const, p00_getopt_synopsis);
...
static_inline int P00_GETOPT_PROCESS (help) (void *p00_o, const char *p00_c) {
    ...
    if (p00_getopt_progname || p00_getopt_synopsis)
        fprintf (
            ...
            (p00_getopt_progname && p00_getopt_synopsis ? " -- " : ""), (p00_getopt_synopsis ? p00_getopt_synopsis : "")
        );
    fprintf (
        stderr, "short  %-*s%-*s%-*s%-*s \t%s\n", p00_ns [0] + 4, "long", p00_ns [1] + 2, "type", p00_ns [2] + 2,
        "name", p00_ns [3] + 2, "default", ""
    );
...
#define P00_GETOPT_ARRAY_ASSIGN_(CHAR)                                                                                 \
    p00_A [p99_getopt_enum##CHAR] = (P00_GETOPT_BOOL (CHAR) ? P00_GETOPT_CHAR (CHAR) : 0)
...
static_inline void p00_getopt_atexit (void) {
...
p99_inline struct const p00_getopt *
    p00_getopt_find_alias (const char *p00_al, size_t p00_size, struct const p00_getopt *p00_A [p00_size]) {
    /* Search for a matching alias in the array */
    struct const p00_getopt *const p00_el = &(struct p00_getopt const) {
        .p00_a = p00_al,
    };
    register struct const p00_getopt *const *p00_p =
        bsearch_s (&p00_el, p00_A, p00_size, sizeof *p00_A, p00_getopt_subcomp, 0);
    if (p00_p && (*p00_p)) {
        /* Now search if there are several matches. */
        while (p00_p != p00_A && !p00_getopt_subcomp (&p00_el, p00_p - 1, 0))
            --p00_p;
...
p99_inline void p00_getopt_diagnostic (const char *p00_err0, const char *p00_err1, const char *p00_err2) {
    fprintf (stderr, "Warning: %s for \"--%s\" with \"%s\"\n", p00_err0, p00_err1, p00_err2);
}
 ...
 **/
static inline void p99_getopt_initialize (int *p00_argc, char ***p00_argv) {
    ...
    const char                     *p00_err0 = 0;
    const char                     *p00_err1 = 0;
    const char                     *p00_err2 = 0;
    /* Create a sorted array with all the aliases, such that we may then
       search for a matching key. */
    static struct const p00_getopt *p00_A [] = {
    ...
    register struct const p00_getopt **p00_up = p00_A;
    while (*p00_up)
        ++p00_up;
    ...
    for (; p00_arg < *p00_argc && (*p00_argv) [p00_arg]; ++p00_arg) {
        ...
        if ((*p00_argv) [p00_arg][0] != '-') {
            ...
            for (const char *p00_str = (*p00_argv) [p00_arg] + 1; p00_str && p00_str [0];) {
                int  p00_used  = 0;
                ...
                switch (p00_C) {
                    ...
                    case '-': {
                        ...
                        /* Search for a matching alias in the array */
                        register struct const p00_getopt *const p00_p =
                            p00_getopt_find_alias (p00_al, p00_up - p00_A, p00_A);
                        if (p00_p) {
                            void *p00_o = p00_p->p00_o;
                            ...
                            if (p00_used >= 0)
                                ...
                                p00_getopt_diagnostic ("unparsable argument", p00_err1, p00_err2);
                        } else
                            p00_getopt_diagnostic ("no or ambiguous option alias", p00_err1, p00_err2);
                        goto P00_REARANGE;
                    }
                }
...
P00_REARANGE:
    if (p00_err0)
        p00_getopt_diagnostic (p00_err0, p00_err1, p00_err2);
