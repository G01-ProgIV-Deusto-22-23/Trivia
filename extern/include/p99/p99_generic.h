 ...
 **/
    ...
    #define P00_GENERIC_LIT_(T, EXP)                                                                                   \
        (EXP) { 0 }

    #define P00_GENERIC_SIZE_LIT(EXP, PAIR, I)                                                                         \
        P00_GENERIC_EXPRESSION (P00_GENERIC_SIZE_, P00_GENERIC_LIT_, EXP, PAIR, I)
    ...
    #define P00_GENERIC_LIT(EXP, PAIR, I)  P00_GENERIC_EXPRESSION (P00_GENERIC_TYPE, P00_GENERIC_LIT_, EXP, PAIR, I)
        ...
        #define P00_GENERIC_(N, MOP, EXP, DEF, ...)                                                                    \
            p99_extension _Generic (                                                                                   \
                (EXP), P99_IF_EMPTY (DEF) () (default                                                                  \
                                              : (DEF), ) P99_FOR ((EXP), N, P00_SEQ, MOP, __VA_ARGS__)                 \
            )
...
__attribute__ ((__error__ ("Invalid choice in type generic expression")))
        #endif
extern size_t
    p00_invalid_type_in_generic (const char *);

        #define P00_INVALID_TYPE_IN_GENERIC(EXP, STR)                                                                  \
            p00_invalid_type_in_generic (__FILE__ P99_STRINGIFY (                                                      \
                : __LINE__                                                                                             \
            ) ": invalid type generic choice `" P99_STRINGIFY (EXP) "` for " STR)
    ...
    #define P00_GENERIC0(MOP, EXP, DEF, ...)                                                                           \
        P00_GENERIC_ (P99_NARG (__VA_ARGS__), P00_ROBUST (MOP), P00_ROBUST (EXP), P00_ROBUST (DEF), __VA_ARGS__)
...
P00_DOCUMENT_PERMITTED_ARGUMENT (P99_GENERIC_SIZE_LIT, 3)
    #define P99_GENERIC_SIZE_LIT(UI, ...) P00_GENERIC_SIZE_LIT0 ((char (*) [(size_t) (UI)]) { 0 }, __VA_ARGS__)
        ...
        #define P99_TYPED_TERN(COND, YES, NO)                                                                          \
            (P99_GENERIC ((char (*) [1 + !!(COND)]) { 0 }, (NO), (char (*) [2], (YES))))
    ...
    /* A first example for the usefulness of type generic
       ...
       ourselves. */
        ...
        #endif
        #define creal(A)                                                                                               \
            P99_GENERIC ((A) + 0, p99_creall, (float _Complex, p99_crealf), (double _Complex, p99_creal))              \
            (A)
        ...
        #endif
        #define cimag(A)                                                                                               \
            P99_GENERIC ((A) + 0, p99_cimagl, (float _Complex, p99_cimagf), (double _Complex, p99_cimag))              \
            (A)
    #endif
    ...
    #define P00_SVALUE_SIG(T, X)                                                                                       \
        (T, (T) (intmax_t) (X)), (T const, (T) (intmax_t) (X)), (T volatile, (T) (intmax_t) (X)),                      \
            (T const volatile, (T) (intmax_t) (X)), (_Atomic (T), (T) (intmax_t) (X)),                                 \
            (_Atomic (T) const, (T) (intmax_t) (X)), (_Atomic (T) volatile, (T) (intmax_t) (X)),                       \
            (_Atomic (T) const volatile, (T) (intmax_t) (X))

    #define P00_SVALUE_UNS(T, X)                                                                                       \
        (T, (T) (uintmax_t) (X)), (T const, (T) (uintmax_t) (X)), (T volatile, (T) (uintmax_t) (X)),                   \
            (T const volatile, (T) (uintmax_t) (X)), (_Atomic (T), (T) (uintmax_t) (X)),                               \
            (_Atomic (T) const, (T) (uintmax_t) (X)), (_Atomic (T) volatile, (T) (uintmax_t) (X)),                     \
    ...
    #define P00_SVALUE_QUAL(X, Q)                                                                                      \
        (char Q, ((char) P99_TYPED_TERN (P00_CHAR_SIGNED, (schar) (intmax_t) (X), (uchar) (uintmax_t) (X)))),          \
            (_Atomic (char) Q,                                                                                         \
             ((char) P99_TYPED_TERN (P00_CHAR_SIGNED, (schar) (intmax_t) (X), (uchar) (uintmax_t) (X))))

    #define P00_SVALUE_CHAR(X)                                                                                         \
        P00_SVALUE_QUAL (X, ), P00_SVALUE_QUAL (X, const), P00_SVALUE_QUAL (X, volatile),                              \
...
P00_DOCUMENT_PERMITTED_ARGUMENT (P99_SVALUE, 0)
    ...
    #define P00_QVALUE_SIG(T, X)                                                                                       \
        (T, (T) (intmax_t) (X)), (T const, (T const) (intmax_t const) (X)),                                            \
            (T volatile, (T volatile) (intmax_t volatile) (X)),                                                        \
            (T const volatile, (T const volatile) (intmax_t const volatile) (X)), (_Atomic (T), (T) (intmax_t) (X)),   \
    ...
    #define P00_QVALUE_UNS(T, X)                                                                                       \
        (T, (T) (uintmax_t) (X)), (T const, (T const) (uintmax_t const) (X)),                                          \
            (T volatile, (T volatile) (uintmax_t volatile) (X)),                                                       \
            (T const volatile, (T const volatile) (uintmax_t const volatile) (X)), (_Atomic (T), (T) (uintmax_t) (X)), \
    ...
    #define P00_QVALUE_QUAL(X, Q)                                                                                      \
        (char Q,                                                                                                       \
         ((char Q) P99_TYPED_TERN (P00_CHAR_SIGNED, (schar Q) (intmax_t Q) (X), (uchar Q) (uintmax_t Q) (X)))),        \
            (_Atomic (char) Q,                                                                                         \
             ((char Q) P99_TYPED_TERN (P00_CHAR_SIGNED, (schar Q) (intmax_t Q) (X), (uchar Q) (uintmax_t Q) (X))))

    #define P00_QVALUE_CHAR(X)                                                                                         \
        P00_QVALUE_QUAL (X, ), P00_QVALUE_QUAL (X, const), P00_QVALUE_QUAL (X, volatile),                              \
            P00_QVALUE_QUAL (X, const volatile)

P00_DOCUMENT_PERMITTED_ARGUMENT (P99_QVALUE, 0)
    #define P99_QVALUE(X)                                                                                              \
        P99_GENERIC (                                                                                                  \
            (X), P00_RVALUE (X), P00_QVALUE_CHAR (X), P00_QVALUE_SIG (schar, X), P00_QVALUE_SIG (sshort, X),           \
            P00_QVALUE_UNS (_Bool, X), P00_QVALUE_UNS (uchar, X), P00_QVALUE_UNS (ushort, X)                           \
        )
...
P00_DOCUMENT_PERMITTED_ARGUMENT (P99_TYPE_CHOICE, 2)
    #define P99_TYPE_CHOICE(EXP, YES, NO, ...)                                                                         \
        P99_GENERIC ((EXP), NO, P99_FOR (YES, P99_NARG (__VA_ARGS__), P00_SEQ, P00_TYPE_CHOICE, __VA_ARGS__))
...
P00_DOCUMENT_PERMITTED_ARGUMENT (P99_SIZE_INDICATOR, 0)
    ...
    #define P00_DECLARE_INLINE_EXPRESSION1(EXT, BASE, EXP, A)                                                          \
        P99_CONST_FUNCTION                                                                                             \
        p99_inline P99_BUILTIN_TYPE (EXT) P99_PASTE3 (p00_gen_, BASE, EXT) (P99_BUILTIN_TYPE (EXT) A) { return (EXP); }

    #define P00_DECLARE_INLINE_EXPRESSION2(EXT, BASE, EXP, A, B)                                                       \
        P99_CONST_FUNCTION                                                                                             \
        p99_inline P99_BUILTIN_TYPE (EXT)                                                                              \
            P99_PASTE3 (p00_gen_, BASE, EXT) (P99_BUILTIN_TYPE (EXT) A, P99_BUILTIN_TYPE (EXT) B) {                    \
            return (EXP);                                                                                              \
        }

    #define P00_DECLARE_INLINE_EXPRESSION3(EXT, BASE, EXP, A, B, C)                                                    \
        p99_inline P99_BUILTIN_TYPE (EXT) P99_PASTE3 (p00_gen_, BASE, EXT) (                                           \
            P99_BUILTIN_TYPE (EXT) A, P99_BUILTIN_TYPE (EXT) B, P99_BUILTIN_TYPE (EXT) C                               \
        ) {                                                                                                            \
            return (EXP);                                                                                              \
        }
    ...
    #define P00_DECLARE_INLINE_EXPRESSION4(EXT, BASE, EXP, A, B, C, D)                                                 \
        p99_inline P99_BUILTIN_TYPE (EXT) P99_PASTE3 (p00_gen_, BASE, EXT) (                                           \
            P99_BUILTIN_TYPE (EXT) A, P99_BUILTIN_TYPE (EXT) B, P99_BUILTIN_TYPE (EXT) C, P99_BUILTIN_TYPE (EXT) D     \
        ) {                                                                                                            \
            return (EXP);                                                                                              \
        }
...
P00_DOCUMENT_PERMITTED_ARGUMENT (P99_GEN_EXPR, 1)
    #define P99_GEN_EXPR(BASE, EXPR, ...)                                                                              \
        P99_GENERIC (                                                                                                  \
            EXPR, p00_invalid_function, P99_FOR (BASE, P99_NARG (__VA_ARGS__), P00_SEQ, P00_GEN_EXPR, __VA_ARGS__)     \
        )

P99_DECLARE_INLINE_EXPRESSIONS ((maximum, (p00_a >= p00_b) ? p00_a : p00_b, p00_a, p00_b), P99_STD_REAL_EXTS);

P00_DOCUMENT_PERMITTED_ARGUMENT (P99_GEN_MAX, 0)
P00_DOCUMENT_PERMITTED_ARGUMENT (P99_GEN_MAX, 1)
    #define P99_GEN_MAX(A, B)                                                                                          \
        P99_GEN_EXPR (maximum, ((A) >= (B)) ? (A) : (B), P99_STD_REAL_EXTS)                                            \
        ((A), (B))

P99_DECLARE_INLINE_EXPRESSIONS ((minimum, (p00_a <= p00_b) ? p00_a : p00_b, p00_a, p00_b), P99_STD_REAL_EXTS);

P00_DOCUMENT_PERMITTED_ARGUMENT (P99_GEN_MIN, 0)
P00_DOCUMENT_PERMITTED_ARGUMENT (P99_GEN_MIN, 1)
    #define P99_GEN_MIN(A, B)                                                                                          \
        P99_GEN_EXPR (minimum, ((A) <= (B)) ? (A) : (B), P99_STD_REAL_EXTS)                                            \
        ((A), (B))

P99_DECLARE_INLINE_EXPRESSIONS (
    (abs, (p00_a >= 0) ? p00_a : -p00_a, p00_a), P99_STD_SIGNED_EXTS, P99_STD_REAL_FLOATING_EXTS
);

P99_DECLARE_INLINE_EXPRESSIONS ((abs, p00_a, p00_a), P99_STD_UNSIGNED_EXTS);
...
inline int *p00_generic_test (int *p00_a) {
    ...
    switch (P99_GEN_ABS (*p00_a % 3)) {
        case 0:
            return P99_GENERIC (
                &*p00_a,
                /* empty default expression */, (int *, p00_a), (double *, p00_x + 1), (float *, p00_x + 2)
            );
    #ifndef P99_CSIN_BUG
        case 1:
            return P99_GENERIC (
                &*p00_a,
                /* another form of empty default */, (double [7], P99_GEN_SIN (((p00_x + 0)))), (int *, p00_a),
                (float *, p00_x + 2)
            );
    #endif
        default:
            return P99_GENERIC (
                &*p00_a,
                /* default expression: */ p00_x, (double *, p00_x + 0), (float [7], p00_x + 1), (int *, p00_a)
            );
    }
}
...
#define P00_SPRINT_DEFINE(T, ...)                                                                                      \
    p99_inline char const *P99_PASTE2 (p00_sprint_, T) (T p00_val, char *restrict p00_str, unsigned p00_form) {        \
        enum {                                                                                                         \
            p00_len = P99_NARG (__VA_ARGS__),                                                                          \
        };                                                                                                             \
        static char const *const p00_format [p00_len] = { __VA_ARGS__ };                                               \
        char const *const        p00_f                = (p00_form < p00_len) ? p00_format [p00_form] : p00_format [0]; \
...
P99_CONST_FUNCTION
p99_inline const char *p00_sprint__Bool (_Bool p00_val, char *restrict p00_str, unsigned p00_form) {
    P99_UNUSED (p00_str);
    P99_UNUSED (p00_form);
    const char *const p00_format [] = {
        "false", "true", "0", "1", "f", "t",
    };
    register const unsigned p00_len = P99_ALEN (p00_format) / 2;
    if (p00_form >= p00_len)
        p00_form = 0;
...
P99_CONST_FUNCTION
p99_inline const volatile char *
    p00_sprint_charp (const volatile char *p00_val, char *restrict p00_str, unsigned p00_form) {
    P99_UNUSED (p00_str);
    P99_UNUSED (p00_form);
    return p00_val;
}

p99_inline const char *p00_sprint_voidp (const volatile void *p00_val, char *restrict p00_str, unsigned p00_form) {
    P99_UNUSED (p00_form);
...
#ifndef __STDC_NO_COMPLEX__
p99_inline const char *p00_sprint_cfloat (cfloat p00_val, char *restrict p00_str, unsigned p00_form) {
    const char *const p00_format [] = {
        "(%g, %g)",
        "(%a, %a)",
    };
    register const unsigned p00_len = P99_ALEN (p00_format);
    const char *const       p00_f   = (p00_form < p00_len) ? p00_format [p00_form] : p00_format [0];
    sprintf (p00_str, p00_f, creal (p00_val), cimag (p00_val));
    return p00_str;
}

p99_inline const char *p00_sprint_cdouble (cdouble p00_val, char *restrict p00_str, unsigned p00_form) {
    const char *const p00_format [] = {
        "(%g, %g)",
        "(%a, %a)",
    };
...
p99_inline const char *p00_sprint_cldouble (cldouble p00_val, char *restrict p00_str, unsigned p00_form) {
    const char *const p00_format [] = {
        "(%Lg, %Lg)",
        "(%La, %La)",
    };
...
p99_inline void p00_sprint_p99x_uintmax_u_ite (p99x_uintmax p00_val, char *restrict p00_str) {
...
p99_inline char *p00_sprint_p99x_uintmax_u (p99x_uintmax p00_val, char *restrict p00_str) {
...
p99_inline void p00_sprint_p99x_uintmax_o_ite (p99x_uintmax p00_val, char *restrict p00_str) {
...
p99_inline char *p00_sprint_p99x_uintmax_o (p99x_uintmax p00_val, char *restrict p00_str) {
    p00_sprint_p99x_uintmax_o_ite (p00_val, p00_str);
    return p00_str;
}

p99_inline void p00_sprint_p99x_uintmax_X_ite (p99x_uintmax p00_val, char *restrict p00_str) {
    uint64_t p00_ar [2 * sizeof (p99x_uintmax) / sizeof (uint64_t)];
    size_t   p00_pos = 0;
    for (;;) {
        /* Mask and shift in that case are less expensive. */
...
p99_inline const char *p00_sprint_p99x_uintmax_X (p99x_uintmax p00_val, char *restrict p00_str) {
    p00_sprint_p99x_uintmax_X_ite (p00_val, p00_str);
    return p00_str;
}

p99_inline const char *p00_sprint_p99x_intmax (p99x_intmax p00_val, char *restrict p00_str, unsigned p00_form) {
    P99_UNUSED (p00_form);
    if (p00_val < 0) {
        p00_str [0] = '-';
...
p99_inline const char *p00_sprint_p99x_uintmax (p99x_uintmax p00_val, char *restrict p00_str, unsigned p00_form) {
    switch (p00_form) {
        default:
...
#define P00_SPRINT_FORMAT_(X, A, ...)                                                                                                                             \
    P99_GENERIC ((X) + 0, p00_sprint_voidp, (char *, p00_sprint_charp), (char const *, p00_sprint_charp), __VA_ARGS__)                                            \
    ((X),                                                                                                                                                         \
     P99_GENERIC (                                                                                                                                                \
         (X) +                                                                                                                                                    \
             0, /* be sure not to have an array for the sizeof */ /* times a rough estimate for octal conversion */ /* plus a rough offset for floating points */ \
         (char [(sizeof (X + 0) * 22 + 64) / 8]) { 0 }, (char *, 0), (char const *, 0)                                                                            \
     ),                                                                                                                                                           \
     (A))
...
#define P99_FORMAT(...)                                                                                                \
    P00_SPRINT_FORMAT (P99_IF_LT (P99_NARG (__VA_ARGS__), 2) (__VA_ARGS__, 0) (__VA_ARGS__), P00_SPRINT_LIST ())
...
#define P00_DEFINE_IN_RANGE(T)                                                                                         \
    P99_CONST_FUNCTION                                                                                                 \
    p99_inline bool P99_PASTE2 (p00_in_range_, T) (T p00_r, T p00_s, T p00_len) {                                      \
        return (p00_r >= p00_s) && ((p00_r - p00_s) < p00_len);                                                        \
    }

P99_CONST_FUNCTION
p99_inline bool p00_in_range_voidp (void *p00_r_, void *p00_s_, size_t p00_len) {
...
#define P99_GENERIC_PCONST(PEXP, NCONST, CONST)                                                                        \
    P99_GENERIC (                                                                                                      \
        (1 ? (PEXP) : (void volatile *) 1), , P00_VOID_QUAL_ (volatile, NCONST),                                       \
...
#define P99_GENERIC_PVOLATILE(PEXP, NVOLATILE, VOLATILE)                                                               \
    P99_GENERIC (                                                                                                      \
        (1 ? (PEXP) : (void const *) 1), , P00_VOID_QUAL_ (const, NVOLATILE),                                          \
...
#define P99_GENERIC_PCONSTVOLATILE(PEXP, NON, FULL)                                                                    \
    P99_GENERIC ((1 ? (PEXP) : (void *) 1), NVOLATILE, P00_VOID_QUAL_ (const volatile, VOLATILE))
...
#define P00_GENERIC_VOIDPTR_OR_INTEGER(PEXP, TRUE, FALSE) P99_GENERIC ((1 ? (void *) 0 : (PEXP)), FALSE, (void *, TRUE))
...
#define P00_GENERIC_NULLPTR_CONSTANT(PEXP, TRUE, FALSE)                                                                \
    P99_GENERIC ((1 ? (p00_nullptr_test *) 0 : (PEXP)), FALSE, (p00_nullptr_test *, TRUE))

#define P00_IS_NULLPTR_CONSTANT(PEXP) P00_GENERIC_NULLPTR_CONSTANT (PEXP, true, false)

#define P99_GENERIC_NULLPTR_CONSTANT_(PEXP, TRUE, FALSE) P00_GENERIC_NULLPTR_CONSTANT (PEXP, TRUE, FALSE)

#define P99_GENERIC_NULLPTR_CONSTANT(PEXP, TRUE, FALSE)                                                                \
    P99_GENERIC_NULLPTR_CONSTANT_ (P00_GENERIC_VOIDPTR_OR_INTEGER (PEXP, PEXP, (void *) 1), TRUE, FALSE)
...
#define P99_GENERIC_INTEGRAL_CONSTANT(EXP, TRUE, FALSE)                                                                \
    P99_GENERIC (                                                                                                      \
        ...
        P99_GENERIC_NULLPTR_CONSTANT (                                                                                 \
            (void *) (ptrdiff_t) ((EXP) - (EXP)), TRUE, FALSE                                                          \
        ), /* avoid to test with arithmetic for void* expressions */                                                   \
        (void *, FALSE), (void const *, FALSE), (void volatile *, FALSE), (void const volatile *, FALSE)               \
    )
...
#define P99_GENERIC_NULLPTR(PEXP, TRUE, FALSE)                                                                         \
    (P99_GENERIC_NULLPTR_CONSTANT (PEXP, TRUE, FALSE) && !P99_GENERIC_INTEGRAL_CONSTANT (PEXP, TRUE, FALSE))
