...
p99_inline bool p00_cm_islocked (unsigned p00_act) {
    return p00_act & 1u;
}

p99_inline bool p00_cm_isntlocked (unsigned p00_act) {
    return ~p00_act & 1u;
}
 ...
 ** @related p99_cm
 **/
p99_inline p99_cm *p99_cm_init (p99_cm *p00_cm) {
    if (p00_cm) {
        *p00_cm = (p99_cm) {
            .waiters = 0,
        };
 ...
 ** @related p99_cm
 **/
p99_inline void p99_cm_destroy (p99_cm *p00_cm) {
...
/* This is only for internal use. Other than @c cnd_signal this
   ...
   is locked. */
p99_inline void p00_cm_signal (volatile p99_cm *p00_cm) {
    if (p00_cm->waiters) {
...
p99_inline void p00_cm_unlock (volatile p99_cm *p00_cm) {
 ...
 ** @related p99_cm
 **/
p99_inline void p99_cm_unlock (volatile p99_cm *p00_cm) {
 ...
 ** @related p99_cm
 **/
p99_inline void p99_cm_lock (volatile p99_cm *p00_cm) {
    P99_FUTEX_COMPARE_EXCHANGE (
        &p00_cm->p00_m, p00_act,
        // wait while locked by another thread
        p00_act == p00_cm_unlocked, p00_cm_locked,
 ...
 ** @related p99_cm
 **/
p99_inline bool p99_cm_trylock (volatile p99_cm *p00_cm) {
...
void p99_cm_wait (volatile p99_cm *p00_cm) {
    ++p00_cm->waiters;
    p00_cm_unlock (p00_cm);
...
#define P00_CM_EXCLUDE(CMP, ID)                                                                                        \
    ...
    P00_BLK_BEFAFT (p99_cm_lock (ID), p99_cm_unlock (ID))                                                              \
    P00_BLK_END
