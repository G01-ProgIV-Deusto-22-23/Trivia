...
#define P00_ARE_ORDERED(OP, N, ...)                                                                                    \
    P99_IF_LT (N, 3)                                                                                                   \
    (P00_ARE_ORDERED2 (OP, __VA_ARGS__)) (P00_ARE_ORDERED3 (OP, P99_PRED (N), __VA_ARGS__))

#define P00_ARE_ORDERED2(OP, X, Y) (X) OP (Y)

#define P00_ARE_ORDERED3(OP, N, ...)                                                                                   \
    ((P99_SUB (0, 1, __VA_ARGS__)) OP P00_ARE_ORDERED_MID (OP, P99_PRED (N), __VA_ARGS__)                              \
...
#define P99_TOKJOIN(TOK, ...)                                                                                          \
    ...
    (__VA_ARGS__) (P99_FOR (TOK, P99_NARG (__VA_ARGS__), P00_TOKJOIN, P00_IDT, __VA_ARGS__))
...
#define P00_ALEN0(NAME)                                                                                                \
    ((sizeof (NAME) / sizeof ((NAME) [0])) / sizeof (char [((!(sizeof (NAME) % sizeof ((NAME) [0]))) << 1) - 1]))
...
#define P00_ACALL3(ARR, N, TYPE)                                                                                       \
    P99_ALENS (*ARR, N),                                                                                               \
        ((TYPE (*const) P99_SUBSCRIPT (P99_ALENS (*ARR, N))) (TYPE *const) { &((*ARR) P99_REP (N, [0])) })
...
P00_DOCUMENT_NUMBER_ARGUMENT (P99_AARG, 2)
    #define P99_AARG(...)                                                                                              \
        P99_IF_GT (P99_NARG (__VA_ARGS__), 3)                                                                          \
        (P00_AARG (__VA_ARGS__)) (P99_PASTE2 (P00_AARG_, P99_NARG (__VA_ARGS__)) (__VA_ARGS__))
P00_DOCUMENT_TYPE_ARGUMENT (P99_ANAME, 0)
P00_DOCUMENT_NUMBER_ARGUMENT (P99_ANAME, 2)
    #define P99_ANAME(...)                                                                                             \
        P99_IF_GT (P99_NARG (__VA_ARGS__), 2)                                                                          \
        (P00_ANAME (__VA_ARGS__)) (P99_PASTE2 (P00_ANAME_, P99_NARG (__VA_ARGS__)) (__VA_ARGS__))
...
#define P00_PRAGMA_DO(PRAG, TYPE, VAR, LOW, LEN, INCR)                                                                 \
    P00_BLK_START                                                                                                      \
    P00_BLK_BEFORE (                                                                                                   \
        const TYPE P99_PASTE2 (p00_start_, VAR) = (LOW),                                                               \
        P99_PASTE2 (p00_stop_, VAR) = P99_PASTE2 (p00_start_, VAR) + (LEN), P99_PASTE2 (p00_incr_, VAR) = (INCR)       \
    )                                                                                                                  \
    P99_PRAGMA (PRAG)                                                                                                  \
...
P00_DOCUMENT_TYPE_ARGUMENT (P99_PRAGMA_DO, 1)
    #define P99_PRAGMA_DO(PRAG, TYPE, VAR, ...)                                                                        \
        ...
        (P00_PRAGMA_DO (PRAG, TYPE, VAR, __VA_ARGS__, 1)) (P00_PRAGMA_DO (PRAG, TYPE, VAR, __VA_ARGS__))
#endif
...
P00_DOCUMENT_NUMBER_ARGUMENT (P99_CASERANGE, 1)
    #define P99_CASERANGE(START, ...)                                                                                  \
        P99_IF_LT (P99_NARG (__VA_ARGS__), 2)                                                                          \
        (P00_CASERANGE2 (START, __VA_ARGS__)) (P00_CASERANGE1 (START, __VA_ARGS__))
#endif
...
#define P99_STRUCT_LITERAL(TYPE, ...)                                                                                  \
    (TYPE) { P99_SEQ (P00_LITERAL, __VA_ARGS__) }
...
#define P00_MAC_ARGS_REAL0(_0, PAIR, I)                                                                                \
    P00_MAC_ARGS_TYPE PAIR P00_MAC_ARGS_QUAL PAIR P99_PASTE2 (p00_mac_arg_, I) = P00_MAC_ARGS_EXP PAIR

#define P00_MAC_ARGS_REAL1(_0, PAIR, I)                                                                                \
    P00_MAC_ARGS_TYPE PAIR P00_MAC_ARGS_QUAL PAIR P00_MAC_ARGS_NAME PAIR = P99_PASTE2 (p00_mac_arg_, I)
...
#define P00_MACRO_VAR(NAME, EXP, ...)                                                                                  \
    __typeof__ (EXP) __VA_ARGS__ P99_PASTE2 (p00_macro_var_, NAME) = (EXP), NAME = P99_PASTE2 (p00_macro_var_, NAME)
...
P00_DOCUMENT_PERMITTED_ARGUMENT (P99_MACRO_VAR, 1)
    #define P99_MACRO_VAR(NAME, ...)                                                                                   \
        ...
        (P00_MACRO_VAR (NAME, __VA_ARGS__, )) (P00_MACRO_VAR (NAME, __VA_ARGS__))

P00_DOCUMENT_IDENTIFIER_ARGUMENT (P99_MACRO_PVAR, 0)
P00_DOCUMENT_PERMITTED_ARGUMENT (P99_MACRO_PVAR, 1)
    #define P99_MACRO_PVAR(NAME, ...)                                                                                  \
        P99_IF_EQ_1 (P99_NARG (__VA_ARGS__))                                                                           \
        (P00_MACRO_PVAR (NAME, __VA_ARGS__, )) (P00_MACRO_PVAR (NAME, __VA_ARGS__))
#endif
