...
P00_POSIX_DEFARG_DOCU (
    pthread_barrier_init, int, pthread_barrier_t *restrict objp, const pthread_barrierattr_t *restrict attr,
    unsigned count
)
...
P00_POSIX_DEFARG_DOCU (pthread_cond_init, int, pthread_cond_t *objp, const pthread_condattr_t *attr)
/*! @param objp is required */
/*! @param attr defaults to 0, such that is @a objp is initialized with default velues */
#define pthread_cond_init(...)       P99_CALL_DEFARG (pthread_cond_init, 2, __VA_ARGS__)
#define pthread_cond_init_defarg_1() 0

P00_POSIX_DEFARG_DOCU (pthread_mutex_init, int, pthread_mutex_t *objp, const pthread_mutexattr_t *attr)
/*! @param objp is required */
/*! @param attr defaults to 0, such that is @a objp is initialized with default velues */
#define pthread_mutex_init(...)       P99_CALL_DEFARG (pthread_mutex_init, 2, __VA_ARGS__)
#define pthread_mutex_init_defarg_1() 0

P00_POSIX_DEFARG_DOCU (pthread_rwlock_init, int, pthread_rwlock_t *objp, const pthread_rwlockattr_t *attr)
/*! @param objp is required */
/*! @param attr defaults to 0, such that is @a objp is initialized with default velues */
...
P00_POSIX_DEFARG_DOCU (inet_ntop, const char *, int af, const void *src, char *dst, socklen_t size)
/**
...
P00_POSIX_DEFARG_DOCU (realpath, char *, const char *path, char *resolved_path)
/**
