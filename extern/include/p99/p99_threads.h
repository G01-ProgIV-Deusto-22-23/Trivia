...
struct p99_once_flag {
        union {
                ...
                enum volatile p00_once p00_vdone;
        } p00_done;
...
#define P99_DECLARE_INIT_ONCE(T, NAME, ARG)                                                                            \
    ...
    p99_inline void P99_PASTE3 (p00_, NAME, _init_func) (T * ARG);                                                     \
    p99_inline void P99_PASTE3 (p00_, NAME, _init_once) (NAME * ARG) {                                                 \
...
p99_inline void p00_call_once_1 (p99_once_flag *p00_flag) {
...
#define p00_call_once(N, ...)                                                                                          \
    P99_IF_EQ_1 (N)                                                                                                    \
    (p00_call_once_1 (__VA_ARGS__)) (P99_IF_EQ_2 (N) (p00_call_once_2 (__VA_ARGS__)) (p00_call_once_3 (__VA_ARGS__)))
 ...
 **/
    ...
    #define P99_DEFINE_ONCE_CHAIN(...)                                                                                 \
        ...
        (P00_P99_DEFINE_ONCE_CHAIN_1 (__VA_ARGS__)) (P00_P99_DEFINE_ONCE_CHAIN_0 (__VA_ARGS__))
#endif
...
#define P99_MUTUAL_EXCLUDE(MUT) P00_MUTUAL_EXCLUDE (MUT, P99_UNIQ (mut))
    ...
    #define P00_MUTUAL_EXCLUDE(MUT, UNIQ)                                                                              \
        ...
        P99_GUARDED_BLOCK (                                                                                            \
            mtx_t *, UNIQ, &(MUT),                                                                                     \
            (void                                                                                                      \
            ) (P99_UNLIKELY (p00_errNo = mtx_lock (UNIQ)) &&                                                           \
               (fprintf (                                                                                              \
                    stderr, __FILE__ ":" P99_STRINGIFY (__LINE__) ": lock error for " P99_STRINGIFY (MUT) ", %s\n",    \
                    strerror (p00_errNo)                                                                               \
                ),                                                                                                     \
                1) &&                                                                                                  \
               (UNIQ = 0, 1) && (P99_UNWIND (-1), 1)),                                                                 \
            (void) (UNIQ && mtx_unlock (UNIQ))                                                                         \
        )
#else
    #define P00_MUTUAL_EXCLUDE(MUT, UNIQ)                                                                              \
        P00_BLK_START                                                                                                  \
...
p99_inline const char *thrd2str (char *p00_buf, thrd_t p00_id) {
