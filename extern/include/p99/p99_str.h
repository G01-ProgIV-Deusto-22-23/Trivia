...
#define P00_DEFINE_STR3(CODE)                                                                                          \
    p99_inline P99_BUILTIN_TYPE (CODE)                                                                                 \
        P99_PASTE2 (str2, CODE) (char const *p00_nptr, size_t *p00_pos, unsigned p00_base) {                           \
        char *p00_eptr;                                                                                                \
        P99_BUILTIN_TYPE (CODE) p00_ret = (strto##CODE) (p00_nptr, (p00_pos ? &p00_eptr : 0), p00_base);               \
        if (p00_pos)                                                                                                   \
            *p00_pos = p00_eptr - p00_nptr;                                                                            \
        return p00_ret;                                                                                                \
    }                                                                                                                  \
...
P00_C99_DEFARG_DOCU (str2l, long, const char *p00_nptr, size_t *p00_pos, unsigned p00_base)
...
P00_C99_DEFARG_DOCU (str2ll, long long, const char *p00_nptr, size_t *p00_pos, unsigned p00_base)
/*! @param p00_nptr is required */
/*! @param p00_pos defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (str2ul, unsigned long, const char *p00_nptr, size_t *p00_pos, unsigned p00_base)
/*! @param p00_nptr is required */
/*! @param p00_pos defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (str2ull, unsigned long long, const char *p00_nptr, size_t *p00_pos, unsigned p00_base)
/*! @param p00_nptr is required */
/*! @param p00_pos defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (str2uz, size_t, const char *p00_nptr, size_t *p00_pos, unsigned p00_base)
/*! @param p00_nptr is required */
/*! @param p00_pos defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (str2t, ptrdiff_t, const char *p00_nptr, size_t *p00_pos, unsigned p00_base)
/*! @param p00_nptr is required */
/*! @param p00_pos defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (str2j, intmax_t, const char *p00_nptr, size_t *p00_pos, unsigned p00_base)
/*! @param p00_nptr is required */
/*! @param p00_pos defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
P00_C99_DEFARG_DOCU (str2uj, uintmax_t, const char *p00_nptr, size_t *p00_pos, unsigned p00_base)
/*! @param p00_nptr is required */
/*! @param p00_pos defaults to 0, meaning that the successfully parsed string is not kept track */
/*! @param p00_base is 0, numbers are hex if they start with 0x, octal if they start with 0 and decimal otherwise */
...
#define P00_DEFINE_STR2(CODE)                                                                                          \
    p99_inline P99_BUILTIN_TYPE (CODE) P99_PASTE2 (str2, CODE) (char const *p00_nptr, size_t *p00_pos) {               \
        char *p00_eptr;                                                                                                \
...
P00_C99_DEFARG_DOCU (str2f, float, const char *p00_nptr, size_t *p00_pos)
/*! @param p00_nptr is required */
/*! @param p00_pos defaults to 0, meaning that the successfully parsed string is not kept track */
#define str2f(...)       P99_CALL_DEFARG (str2f, 2, __VA_ARGS__)
#define str2f_defarg_1() 0

P00_C99_DEFARG_DOCU (str2d, double, const char *p00_nptr, size_t *p00_pos)
/*! @param p00_nptr is required */
/*! @param p00_pos defaults to 0, meaning that the successfully parsed string is not kept track */
#define str2d(...)       P99_CALL_DEFARG (str2d, 2, __VA_ARGS__)
#define str2d_defarg_1() 0

P00_C99_DEFARG_DOCU (str2ld, long double, const char *p00_nptr, size_t *p00_pos)
/*! @param p00_nptr is required */
/*! @param p00_pos defaults to 0, meaning that the successfully parsed string is not kept track */
