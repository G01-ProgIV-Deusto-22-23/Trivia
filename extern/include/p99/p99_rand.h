...
p99_inline uint32_t p00_xorshift (p00_seed160 *p00_s) {
    /* Use the 6th element as the running index, and compute the
       necessary derived indices mod 5 */
    ++(*p00_s) [5];
    register const uint32_t p00_0 = ((*p00_s) [5]) % 5;
    register const uint32_t p00_4 = p00_0 == 0 ? 4 : p00_0 - 1;
    register const uint32_t p00_2 = (p00_0 == 4) ? 1 : ((p00_0 == 3) ? 0 : p00_0 + 2);

    /* Load the part of the state variable that we need. */
    register const uint32_t p00_x = (*p00_s) [p00_0];
    register const uint32_t p00_y = (*p00_s) [p00_2];
    register const uint32_t p00_v = (*p00_s) [p00_4];
...
#define P00_BIGPRIME                                                                                                   \
    UINT64_C (10007814641597694113), UINT64_C (10015183610531627897), UINT64_C (10089390291074425231),                 \
        UINT64_C (10117275823191396191), UINT64_C (10215588060907623179), UINT64_C (10389441874873414061),             \
        UINT64_C (10602620510410479149), UINT64_C (10690793455755991027), UINT64_C (10793439684376201283),             \
        UINT64_C (10969167379420052431), UINT64_C (11050883422537956197), UINT64_C (11110712460003231287),             \
        UINT64_C (11342254921836171103), UINT64_C (11388752923558666351), UINT64_C (11682943258734137249),             \
        UINT64_C (11697622259988783581), UINT64_C (11731205802697935733), UINT64_C (11799524298339249581),             \
        UINT64_C (11862963432241722239), UINT64_C (11903172551239393097), UINT64_C (11937270107112816793),             \
        UINT64_C (11962673972948293321), UINT64_C (12001454206321043837), UINT64_C (12066567988703197129),             \
        UINT64_C (12090279337620046961), UINT64_C (12320220036580238077), UINT64_C (12409336420886496139),             \
        UINT64_C (12441355201341188273), UINT64_C (12444926949253327381), UINT64_C (12464345941324672183),             \
        UINT64_C (12469071720100075169), UINT64_C (12541090550165194183), UINT64_C (12558029109792848393),             \
        UINT64_C (12629045726855953273), UINT64_C (12845265184712635099), UINT64_C (12904165305535099733),             \
        UINT64_C (12949777725323667257), UINT64_C (13014679980528315931), UINT64_C (13027415158206533719),             \
        UINT64_C (13073256976558063279), UINT64_C (13153853421202095331), UINT64_C (13381351390611252151),             \
        UINT64_C (13825543164380321747), UINT64_C (13917403769616578911), UINT64_C (13929904570285153753),             \
        UINT64_C (14140216129016347127), UINT64_C (14184039880925065139), UINT64_C (14271570646513640671),             \
        UINT64_C (14446852824178510313), UINT64_C (14666997777683867003), UINT64_C (14692182605128454039),             \
        UINT64_C (14771388299183335229), UINT64_C (15059759696658839237), UINT64_C (15091316017205268437),             \
        UINT64_C (15180626055737690959), UINT64_C (15339437418814258573), UINT64_C (15601183704045111169),             \
        UINT64_C (15983170142123181797), UINT64_C (16545722488476290101), UINT64_C (16580005714519352107),             \
        UINT64_C (16589193612296178103), UINT64_C (16620171437104037921), UINT64_C (16713706803710883721),             \
        UINT64_C (16826711990149094791), UINT64_C (16886322755473635461), UINT64_C (16950140700365130619),             \
        UINT64_C (16952043704640877837), UINT64_C (17020386452131177189), UINT64_C (17020824347466355583),             \
        UINT64_C (17044414685455096133), UINT64_C (17089443963053420461), UINT64_C (17165479835541081871),             \
        UINT64_C (17185820514261086599), UINT64_C (17191892745505804273), UINT64_C (17613198595545138731),             \
        UINT64_C (17653178755564367203), UINT64_C (17653752776501147281), UINT64_C (17728444844615762171),             \
        UINT64_C (17744620187156425403), UINT64_C (17816722786105806973), UINT64_C (17831662963314755641),             \
        UINT64_C (17886004545482299117), UINT64_C (17920151933265509833), UINT64_C (17969552600607433963),             \
        UINT64_C (18066918898331824901), UINT64_C (18094173144238831753), UINT64_C (18134240252569387847),             \
        UINT64_C (18219113917191524677), UINT64_C (18298168206731166317), UINT64_C (18319234190200763803)

P99_CONST_FUNCTION
p99_inline uint32_t p00_bitpack (const void *p00_p) {
...
void p00_rand_init (void *p00_p) {
    p99_seed       *p00_s = p00_p ? p00_p : &P99_THREAD_LOCAL (p00_seed).p00_seed;
    ...
    p00_seed160 p00_st  = {
        p00_0, p00_1, p00_2, p00_3, p00_4, p00_ind,
    };
    /* mix things up a bit */
    for (unsigned p00_i = 0; p00_i < 32; ++p00_i)
        p00_xorshift (&p00_st);
 ...
 **/
p99_inline p99_seed *p99_seed_get (void) {
...
const uint64_t p00_bigprime [] = { P00_BIGPRIME };
...
p99_inline uint64_t p99_rand (register p99_seed *p00_seed) {
...
p99_inline double p99_drand (register p99_seed *p00_seed) {
    enum {
    ...
    const double p00_imax = 1.0 / (UINT64_C (1) << p00_s);
