            ...
            for (;;) {                                                                                                 \
                if (p00_head) {                                                                                        \
                    ...
                    if (atomic_compare_exchange_weak_explicit (                                                        \
                            p00_h, &p00_head, 0, memory_order_acq_rel, memory_order_relaxed                            \
                        )) {                                                                                           \
                    ...
                    if (!p00_tail && atomic_compare_exchange_weak_explicit (                                           \
                                         p00_t, &p00_tail, p00_el, memory_order_acq_rel, memory_order_relaxed          \
                                     )) {                                                                              \
...
#define P00_FIFO_TABULATE(TYPE, TAB, ID, L)                                                                            \
    ...
    for (TYPE *p00_e = P99_PASTE2 (ID, _head); p00_e; p00_e = p00_e->p99_lifo)                                         \
        ++P99_PASTE2 (ID, _cnt);                                                                                       \
    TYPE *TAB [P99_PASTE2 (ID, _cnt)];                                                                                 \
    for (TYPE **p00_t = &(TAB [0]), *p00_e = P99_PASTE2 (ID, _head); p00_e; p00_e = p00_e->p99_lifo, ++p00_t)          \
    *p00_t = p00_e
