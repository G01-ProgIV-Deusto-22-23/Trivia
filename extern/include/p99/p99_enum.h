...
#define P00_ENUM_CASE(X)                                                                                               \
    case X:                                                                                                            \
        return P99_STRINGIFY (X)
...
P00_DOCUMENT_DECLARATION_ARGUMENT (P99_DECLARE_ENUM_GETNAME, 3)
    #define P99_DECLARE_ENUM_GETNAME(T, ...)                                                                           \
        P99_CONST_FUNCTION                                                                                             \
        p99_inline char const *P99_PASTE2 (T, _getname) (T p00_x) {                                                    \
...
P00_DOCUMENT_DECLARATION_ARGUMENT (P99_DECLARE_ENUM_PARSE, 3)
    #define P99_DECLARE_ENUM_PARSE(T, ...)                                                                             \
        P99_PURE_FUNCTION                                                                                              \
        p99_inline T P99_PASTE2 (T, _parse) (char const p00_s []) {                                                    \
...
P00_DOCUMENT_DECLARATION_ARGUMENT (P99_DECLARE_ENUM, 3)
    #define P99_DECLARE_ENUM(T, ...)                                                                                   \
        ...
        enum T {                                                                                                       \
            __VA_ARGS__,             /*! upper bound of the @ref T constants */                                        \
            P99_PASTE2 (T, _amount), /*! the largest @ref T constant */                                                \
            P99_PASTE2 (T, _max) = ((size_t) (P99_PASTE2 (T, _amount)) - 1u), /*! the smallest @ref T constant */      \
            P99_PASTE2 (T, _min) = 0                                                                                   \
        };                                                                                                             \
...
P99_CONST_FUNCTION
p99_inline const char *bool_getname (bool p00_x) {
    switch ((uintmax_t) p00_x) {
        case 0:
            return "false";
        case 1:
...
#define P00_CONSTANT_STATIC_3(T, NAME, ...)                                                                            \
...
#define P00_CONSTANT_2(T, NAME)                                                                                        \
    P99_IF_INT (T)                                                                                                     \
    (P00_CONSTANT_ENUM_1 (NAME)) (P00_CONSTANT_STATIC_3 (T, NAME, P99_INIT))

#define P00_CONSTANT_3(T, NAME, ...)                                                                                   \
    P99_IF_INT (T)                                                                                                     \
    (P00_CONSTANT_ENUM_2 (NAME, __VA_ARGS__)) (P00_CONSTANT_STATIC_3 (T, NAME, __VA_ARGS__))
...
P00_DOCUMENT_IDENTIFIER_ARGUMENT (P99_CONSTANT, 1)
    #define P99_CONSTANT(...)                                                                                          \
        ...
        (P00_CONSTANT_2 (__VA_ARGS__)) (P00_CONSTANT_3 (__VA_ARGS__))
#endif
...
P99_DECLARE_ENUM_GETNAME (p99_endianness, p99_big_endian, p99_little_endian, p99_pdp_endian);
