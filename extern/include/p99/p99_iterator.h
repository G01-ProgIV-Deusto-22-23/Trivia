...
p99_inline p99_iterator *p99_iterator_init (p99_iterator *p00_i) {
    if (p00_i) {
        p00_i->p00_act = 0;
 ...
 ** @related p99_iterator
 **/
p99_inline void p99_iterator_destroy (p99_iterator *p00_i) {
    if (p00_i)
...
unsigned p99_iterator_next (volatile p99_iterator *p00_i) {
    register const unsigned p00_act = p00_i->p00_act;
    P99_FUTEX_COMPARE_EXCHANGE (
        &p00_i->p00_seen, p00_seen,
...
p99_inline unsigned p99_iterator_signal (volatile p99_iterator *p00_i) {
...
p99_inline p99_event *p99_event_init (p99_event *p00_e, unsigned p00_n) {
    if (p00_e) {
        (*p00_e) = (p99_event) {
            .p00_n     = p00_n,
 ...
 ** @related p99_event
 **/
p99_inline void p99_event_destroy (p99_event *p00_e) {
    if (p00_e) {
...
void *p99_event_next (volatile p99_event *p00_e) {
...
p99_inline void p99_event_signal (volatile p99_event *p00_e, void *p00_w) {
    if (p00_e) {
