 ...
 **/
P99_CONST_FUNCTION
p99_inline int thrd_equal (thrd_t p00_thr0, thrd_t p00_thr1) {
...
p99_inline int cnd_broadcast (cnd_t *p00_cond) {
 ...
 ** @related cnd_t
 **/
p99_inline void cnd_destroy (cnd_t *p00_cond) {
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int cnd_init (cnd_t *p00_cond) {
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int cnd_signal (cnd_t *p00_cond) {
...
P99_WARN_UNUSED_RESULT
p99_inline int
    cnd_timedwait (cnd_t *restrict p00_cond, mtx_t *restrict p00_mtx, const struct timespec *restrict p00_ts) {
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int cnd_wait (cnd_t *p00_cond, mtx_t *p00_mtx) {
 ...
 ** @related mtx_t
 **/
p99_inline void mtx_destroy (mtx_t *p00_mtx) {
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int mtx_init (mtx_t *p00_mtx, int p00_type) {
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int mtx_lock (mtx_t *p00_mtx) {
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int mtx_timedlock (mtx_t *restrict p00_mtx, const struct timespec *restrict p00_ts) {
 ...
 ** not be honored.
 **/
p99_inline int mtx_trylock (mtx_t *p00_mtx) {
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int mtx_unlock (mtx_t *p00_mtx) {
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int thrd_create (thrd_t *p00_thr, thrd_start_t p00_func, void *p00_arg) {
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int thrd_detach (thrd_t p00_thr) {
...
#else
p99_inline _Noreturn void thrd_exit (int p00_res) {
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int thrd_join (thrd_t p00_thr, int *p00_res) {
    void *p00_res0;
 ...
 **/
P99_WARN_UNUSED_RESULT
p99_inline int thrd_sleep (const struct timespec *p00_duration, struct timespec *p00_remaining) {
    errno       = 0;
