...
#define P00_QSORT_BODY(SWAP)                                                                                           \
    if (p00_n > RSIZE_MAX || p00_s > RSIZE_MAX)                                                                        \
        return EDOM;                                                                                                   \
    if (p00_n && (!p00_base || !p00_comp))                                                                             \
        return EINVAL;                                                                                                 \
    do {                                                                                                               \
            ...
            switch (p00_len) {                                                                                         \
                ...
                default:                                                                                               \
                    ...
                    {                                                                                                  \
                        ...
                        if (p00_c)                                                                                     \
                            SWAP (p00_B, p00_bot, p00_bot + p00_c);                                                    \
                    }                                                                                                  \
                                                                                                                       \
                ...
                P00_RECURSE:                                                                                           \
                    if ((p00_b - p00_bot) > 1) {                                                                       \
                        ...
                        for (register size_t p00_c = p00_bot; p00_c < p00_b;) {                                        \
                    ...
                    if (P99_UNLIKELY (p00_len >= p00_tail)) {                                                          \
                        ...
                        if (P99_UNLIKELY (((p00_b - p00_bot) >= p00Mmax) || ((p00_top - p00_t) >= p00Mmax)))           \
                            continue;                                                                                  \
                    }                                                                                                  \
                    --p00_p;                                                                                           \
                    if ((p00_b - p00_bot) > 1)                                                                         \
...
p99_inline errno_t p00_qsort_generic16 (
    void *p00_base, rsize_t p00_n, rsize_t p00_a, rsize_t p00_s, int (*p00_comp) (const void *, const void *, void *),
    void *p00_ctx
) {
    P99_UNUSED (p00_a);
    const size_t           p00_vsize = p00_s / sizeof (uint16_t);
...
p99_inline errno_t p00_qsort_generic32 (
    void *p00_base, rsize_t p00_n, rsize_t p00_a, rsize_t p00_s, int (*p00_comp) (const void *, const void *, void *),
    void *p00_ctx
) {
    P99_UNUSED (p00_a);
    const size_t           p00_vsize = p00_s / sizeof (uint32_t);
...
p99_inline errno_t p00_qsort_generic64 (
    void *p00_base, rsize_t p00_n, rsize_t p00_a, rsize_t p00_s, int (*p00_comp) (const void *, const void *, void *),
    void *p00_ctx
) {
    P99_UNUSED (p00_a);
    const size_t           p00_vsize = p00_s / sizeof (uint64_t);
...
#ifdef UINT128_MAX
p99_inline errno_t p00_qsort_generic128 (
    void *p00_base, rsize_t p00_n, rsize_t p00_a, rsize_t p00_s, int (*p00_comp) (const void *, const void *, void *),
    void *p00_ctx
) {
    P99_UNUSED (p00_a);
    const size_t           p00_vsize = p00_s / sizeof (uint128_t);
...
p99_inline errno_t p00_qsort_generic128 (
    ...
    P99_UNUSED (p00_a);
    const size_t           p00_vsize = p00_s / sizeof (p99x_uint128);
...
p99_inline errno_t p00_qsort_generic (
    void *p00_base, rsize_t p00_n, rsize_t p00_a, rsize_t p00_s, int (*p00_comp) (const void *, const void *, void *),
    void *p00_ctx
) {
    P99_UNUSED (p00_a);
...
#define P00_QSORT_DECLARE(T)                                                                                           \
    p99_inline errno_t P99_PASTE2 (p00_qsort_, T) (                                                                    \
        void *p00_base, rsize_t p00_n, rsize_t p00_a, rsize_t p00_s,                                                   \
        int (*p00_comp) (const void *, const void *, void *), void *p00_ctx                                            \
    ) {                                                                                                                \
        P99_UNUSED (p00_a);                                                                                            \
...
p99_inline errno_t p00_qsort_s (
    void *p00_base, rsize_t p00_n, rsize_t p00_a, rsize_t p00_s, int (*p00_comp) (const void *, const void *, void *),
    void *p00_ctx
) {
    switch (p00_a) {
    ...
    #define P99_ALIGNOF(B) alignof (P99_TYPEOF (B))
        ...
        #define P99_ALIGNOF(B)                                                                                         \
            P99_GENERIC (                                                                                              \
                &((B) [0]), sizeof ((B) [0]), (void_ptr *, 1),                                           /* */         \
                (float *, alignof (float)), (double *, alignof (double)), (double *, alignof (cdouble)), /* */         \
                (_Bool *, alignof (_Bool)), (char *, alignof (char)), (uchar *, alignof (uchar)),                      \
                (schar *, alignof (schar)),                                     /* */                                  \
                (ushort *, alignof (ushort)), (short *, alignof (short)),       /* */                                  \
                (unsigned *, alignof (unsigned)), (signed *, alignof (signed)), /* */                                  \
                (long *, alignof (long)), (ulong *, alignof (ulong)),           /* */                                  \
                (llong *, alignof (llong)), (ullong *, alignof (ullong))                                               \
            )
    #else
        #define P99_ALIGNOF(B)                                                                                         \
            P99_GENERIC (                                                                                              \
                &((B) [0]), sizeof ((B) [0]), (void_ptr *, 1),                                                  /* */  \
                (float *, alignof (float)), (double *, alignof (double)), (ldouble *, alignof (ldouble)),       /* */  \
                (cfloat *, alignof (cfloat)), (cdouble *, alignof (cdouble)), (cldouble *, alignof (cldouble)), /* */  \
                (_Bool *, alignof (_Bool)), (char *, alignof (char)), (uchar *, alignof (uchar)),                      \
                (schar *, alignof (schar)),                                     /* */                                  \
                (ushort *, alignof (ushort)), (short *, alignof (short)),       /* */                                  \
                (unsigned *, alignof (unsigned)), (signed *, alignof (signed)), /* */                                  \
 ...
 **/
    ...
    #define qsort_s(B, N, S, CMP, CTX)                                                                                 \
        P99_CONSTRAINT_TRIGGER (                                                                                       \
            P99_GENERIC (                                                                                              \
                &((B) [0]), p00_qsort_s, (void_ptr *, p00_qsort_void_ptr),                               /* */         \
                (float *, p00_qsort_float), (double *, p00_qsort_double), (double *, p00_qsort_cdouble), /* */         \
                (_Bool *, p00_qsort__Bool), (char *, p00_qsort_char), (uchar *, p00_qsort_uchar),                      \
                (schar *, p00_qsort_schar),                                     /* */                                  \
                (ushort *, p00_qsort_ushort), (short *, p00_qsort_short),       /* */                                  \
                (unsigned *, p00_qsort_unsigned), (signed *, p00_qsort_signed), /* */                                  \
                (long *, p00_qsort_long), (ulong *, p00_qsort_ulong),           /* */                                  \
                (llong *, p00_qsort_llong), (ullong *, p00_qsort_ullong)                                               \
    ...
    #define qsort_s(B, N, S, CMP, CTX)                                                                                 \
        P99_CONSTRAINT_TRIGGER (                                                                                       \
            P99_GENERIC (                                                                                              \
                &((B) [0]), p00_qsort_s, (void_ptr *, p00_qsort_void_ptr),                                      /* */  \
                (float *, p00_qsort_float), (double *, p00_qsort_double), (ldouble *, p00_qsort_ldouble),       /* */  \
                (cfloat *, p00_qsort_cfloat), (cdouble *, p00_qsort_cdouble), (cldouble *, p00_qsort_cldouble), /* */  \
                (_Bool *, p00_qsort__Bool), (char *, p00_qsort_char), (uchar *, p00_qsort_uchar),                      \
                (schar *, p00_qsort_schar),                                     /* */                                  \
                (ushort *, p00_qsort_ushort), (short *, p00_qsort_short),       /* */                                  \
                (unsigned *, p00_qsort_unsigned), (signed *, p00_qsort_signed), /* */                                  \
 ...
 **/
p99_inline rsize_t p99_mismatch (
    void *p00_base, rsize_t p00_n, rsize_t p00_s, int (*p00_comp) (const void *, const void *, void *), void *p00_ctx
) {
    typedef unsigned char p00_el [p00_s];
