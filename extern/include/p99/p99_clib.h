 ...
 **/
p99_inline void *aligned_alloc (size_t p00_alignment, size_t p00_size) {
    void *p00_ret = 0;
 ...
 **/
p99_inline int at_quick_exit (void (*p00_void_func) (void)) {
 ...
 ** @see at_quick_exit
 **/
p99_inline _Noreturn void quick_exit (int status) {
 ...
 **/
p99_inline int at_thrd_exit (void (*p00_void_func) (void)) {
...
p99_inline int p00_timespec_get (struct timespec *p00_ts, int p00_base) {
    struct timeval t;
...
P99_CONST_FUNCTION
p99_inline clockid_t p00_getclockid (int base) {
    return (base >= p00_time_base_max) ? CLOCK_REALTIME
                                       : (clockid_t const []) {
...
struct const timespec *const p00_timeoff = &p00_timeoff_;

P99_WEAK (p00_timeonce)
once_flag p00_timeonce = ONCE_FLAG_INIT;

p99_inline void p00_timeonce_init (void) {
    ...
    const uint64_t p00_giga  = UINT64_C (1000000000);
...
p99_inline int timespec_get (struct timespec *p00_ts, int p00_base) {
    ...
    uint64_t                p00_nsec = mach_absolute_time () * p00_timebase;
    register const uint64_t p00_giga = UINT64_C (1000000000);
