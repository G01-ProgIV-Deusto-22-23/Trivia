...
#define p00_mfence(...)                                                                                                \
    ...
    (__atomic_thread_fence (__ATOMIC_SEQ_CST)) (__atomic_thread_fence (__VA_ARGS__))

#define p00_sync_lock_release(...)                                                                                     \
    P99_IF_LT (P99_NARG (__VA_ARGS__), 2)                                                                              \
    (p00_atomic_clear (__VA_ARGS__, __ATOMIC_SEQ_CST)) (p00_atomic_clear (__VA_ARGS__))

#define p00_sync_lock_test_and_set(...)                                                                                \
    P99_IF_LT (P99_NARG (__VA_ARGS__), 2)                                                                              \
    (p00_atomic_test_and_set (__VA_ARGS__, __ATOMIC_SEQ_CST)) (p00_atomic_test_and_set (__VA_ARGS__))
