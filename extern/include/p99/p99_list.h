...
#define P99_BRACKETS(...)                                                                                              \
    P99_PASTE2 (P00_BRACKETS_, P99_IS_LT (P99_NARG (__VA_ARGS__), 1)) (P99_NARG (__VA_ARGS__), __VA_ARGS__)
...
#define P99_PARENS(...)                                                                                                \
    P99_PASTE2 (P00_PARENS_, P99_IS_LT (P99_NARG (__VA_ARGS__), 1)) (P99_NARG (__VA_ARGS__), __VA_ARGS__)
...
#define P99_BRACES(...)                                                                                                \
    P99_PASTE2 (P00_BRACES_, P99_IS_LT (P99_NARG (__VA_ARGS__), 1)) (P99_NARG (__VA_ARGS__), __VA_ARGS__)
