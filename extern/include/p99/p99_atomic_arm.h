...
/* When in arm mode we can't do addressing with offset, here, so use
   direct addressing. */
p99_inline uint8_t p00_arm_ldrexb (volatile uint8_t *p00_ptr) {
    uint8_t p00_ret;
    __asm__ volatile ("ldrexb %0,[%1]\t@ load exclusive\n" : "=&r"(p00_ret) : "r"(p00_ptr) : "cc", "memory");
    return p00_ret;
}

p99_inline _Bool p00_arm_strexb (volatile uint8_t *p00_ptr, uint8_t p00_val) {
    uint32_t p00_ret;
...
p99_inline uint16_t p00_arm_ldrexh (volatile uint16_t *p00_ptr) {
    uint16_t p00_ret;
    __asm__ volatile ("ldrexh %0,[%1]\t@ load exclusive\n" : "=&r"(p00_ret) : "r"(p00_ptr) : "cc", "memory");
    return p00_ret;
}

p99_inline _Bool p00_arm_strexh (volatile uint16_t *p00_ptr, uint16_t p00_val) {
    uint32_t p00_ret;
...
p99_inline uint32_t p00_arm_ldrex (volatile uint32_t *p00_ptr) {
    uint32_t p00_ret;
    __asm__ volatile ("ldrex %0,[%1]\t@ load exclusive\n" : "=&r"(p00_ret) : "r"(p00_ptr) : "cc", "memory");
    return p00_ret;
}

p99_inline _Bool p00_arm_strex (volatile uint32_t *p00_ptr, uint32_t p00_val) {
    uint32_t p00_ret;
...
p99_inline uint64_t p00_arm_ldrexd (volatile uint64_t *p00_ptr) {
    uint64_t p00_ret;
    __asm__ volatile ("ldrexd %0, %H0, [%1]\t@ load exclusive\n" : "=&r"(p00_ret) : "r"(p00_ptr) : "cc", "memory");
    return p00_ret;
}

p99_inline _Bool p00_arm_strex (volatile uint64_t *p00_ptr, uint64_t p00_val) {
    uint32_t p00_ret;
...
p99_inline _Bool p00_arm_strexd (volatile uint64_t *p00_ptr, uint64_t p00_val) {
    uint32_t p00_ret;
...
p99_inline uint8_t p00_atomic_exchange_1 (volatile uint8_t *p00_objp, uint8_t p00_des) {
    for (;;) {
        uint8_t p00_ret = p00_arm_ldrexb (object);
        if (!p00_arm_strexb (object, p00_des))
            return p00_ret;
    }
}

p99_inline uint16_t p00_atomic_exchange_2 (volatile uint16_t *p00_objp, uint16_t p00_des) {
    for (;;) {
        uint16_t p00_ret = p00_arm_ldrexh (object);
        if (!p00_arm_strexh (object, p00_des))
            return p00_ret;
    }
}

p99_inline uint32_t p00_atomic_exchange_4 (volatile uint32_t *p00_objp, uint32_t p00_des) {
    for (;;) {
        uint32_t p00_ret = p00_arm_ldrex (object);
        if (!p00_arm_strex (object, p00_des))
            return p00_ret;
    }
}

#if defined(__GCC_HAVE_SYNC_COMPARE_AND_SWAP_8) || defined(P00_DOXYGEN)
p99_inline uint64_t p00_atomic_exchange_8 (volatile uint64_t *p00_objp, uint64_t p00_des) {
    for (;;) {
        uint64_t p00_ret = p00_arm_ldrexd (object);
        if (!p00_arm_strexd (object, p00_des))
            return p00_ret;
    }
}
#endif
...
p99_inline uint32_t p00_sync_lock_test_and_set (volatile uint32_t *p00_objp) {
    return __sync_lock_test_and_set (p00_objp, 1);
}

p99_inline void p00_sync_lock_release (volatile uint32_t *p00_objp) {
    __sync_lock_release (p00_objp);
}

p99_inline void p00_mfence (void) {
    __sync_synchronize ();
}
...
p99_inline uint32_t p00_sync_lock_test_and_set_internal (volatile uint32_t *object, memory_order p00_ord) {
    for (;;) {
        uint32_t p00_ret = p00_arm_ldrex (object);
        ...
        if (!p00_arm_strex (object, 1) || p00_ret)
            return p00_ret;
    }
}

p99_inline void p00_sync_lock_release_internal (volatile uint32_t *object, memory_order p00_ord) {
    __sync_lock_release (object);
}

p99_inline void p00_mfence_internal (memory_order p00_ord) {
    ...
    #define p00_sync_lock_release(...)                                                                                 \
        ...
        (p00_sync_lock_release_internal (__VA_ARGS__)) (p00_sync_lock_release_internal (P99_ALLBUTLAST (__VA_ARGS__)))
...
p99_inline uint32_t __sync_val_compare_and_swap_4 (volatile uint32_t *object, uint32_t p00_pre, uint32_t p00_des) {
    uint32_t p00_ret = 0;
    for (;;) {
...
p99_inline uint32_t __sync_fetch_and_add_4 (volatile uint32_t *object, uint32_t p00_val) {
    uint32_t p00_ret = 0;
    for (;;) {
        p00_ret          = p00_arm_ldrex (object);
...
p99_inline uint32_t __sync_fetch_and_sub_4 (volatile uint32_t *object, uint32_t p00_val) {
    uint32_t p00_ret = 0;
    for (;;) {
        p00_ret          = p00_arm_ldrex (object);
        uint32_t p00_des = p00_ret - p00_val;
...
p99_inline uint32_t __sync_fetch_and_or_4 (volatile uint32_t *object, uint32_t p00_val) {
    uint32_t p00_ret = 0;
    for (;;) {
        p00_ret          = p00_arm_ldrex (object);
        uint32_t p00_des = p00_ret | p00_val;
...
p99_inline uint32_t __sync_fetch_and_and_4 (volatile uint32_t *object, uint32_t p00_val) {
    uint32_t p00_ret = 0;
    for (;;) {
        p00_ret          = p00_arm_ldrex (object);
        uint32_t p00_des = p00_ret & p00_val;
...
p99_inline uint32_t __sync_fetch_and_xor_4 (volatile uint32_t *object, uint32_t p00_val) {
    uint32_t p00_ret = 0;
    for (;;) {
        p00_ret          = p00_arm_ldrex (object);
        uint32_t p00_des = p00_ret ^ p00_val;
