 ...
 **/
    ...
    #define P99_DECLARE_ATOMIC(...)                                                                                    \
        /** @brief Atomic access to a value of type <code>T</code> @see atomic_int for the possible operations on this \
         * type */                                                                                                     \
        P99_IF_EQ_1 (P99_NARG (__VA_ARGS__))                                                                           \
        (P00_DECLARE_ATOMIC2 (__VA_ARGS__, P99_PASTE2 (atomic_, __VA_ARGS__))) (P00_DECLARE_ATOMIC2 (__VA_ARGS__))
...
P99_DECLARE_ENUM (
    memory_order, memory_order_relaxed, memory_order_consume, memory_order_acquire, memory_order_release,
         ...
         **/
            ...
            #define ATOMIC_POINTER_LOCK_FREE ATOMIC_INTPTR_LOCK_FREE
                ...
                #define P00_UINT_TYPE_LIST                                                                             \
                    (1, uintptr_t) P00_TYPE_LIST_ELEM2 P00_TYPE_LIST_ELEM4 P00_TYPE_LIST_ELEM8 P00_TYPE_LIST_ELEM16
            #elif UINTPTR_MAX == UINT16_MAX
                #define P00_UINT_TYPE_LIST                                                                             \
                    (2, uintptr_t) P00_TYPE_LIST_ELEM1 P00_TYPE_LIST_ELEM4 P00_TYPE_LIST_ELEM8 P00_TYPE_LIST_ELEM16
            #elif UINTPTR_MAX == UINT32_MAX
                #define P00_UINT_TYPE_LIST                                                                             \
                    (4, uintptr_t) P00_TYPE_LIST_ELEM1 P00_TYPE_LIST_ELEM2 P00_TYPE_LIST_ELEM8 P00_TYPE_LIST_ELEM16
            #elif UINTPTR_MAX == UINT64_MAX
                #define P00_UINT_TYPE_LIST                                                                             \
                    (8, uintptr_t) P00_TYPE_LIST_ELEM1 P00_TYPE_LIST_ELEM2 P00_TYPE_LIST_ELEM4 P00_TYPE_LIST_ELEM16
            #elif UINTPTR_MAX == UINT128_MAX
                #define P00_UINT_TYPE_LIST                                                                             \
                    (16, uintptr_t) P00_TYPE_LIST_ELEM1 P00_TYPE_LIST_ELEM2 P00_TYPE_LIST_ELEM4 P00_TYPE_LIST_ELEM8
            #else
                #define P00_UINT_TYPE_LIST                                                                             \
                    (1, uint8_t) P00_TYPE_LIST_ELEM2 P00_TYPE_LIST_ELEM4 P00_TYPE_LIST_ELEM8 P00_TYPE_LIST_ELEM16
            #endif
        #endif
...
typedef volatile uint32_t p00_atomic_flag;
...
P00_DOCUMENT_IDENTIFIER_ARGUMENT (P99_DECLARE_ATOMIC_LOCK_FREE, 1)
            ...
            #define P99_DECLARE_ATOMIC_LOCK_FREE(T, NAME)                                                              \
                /** @brief Atomic access to a value of type <code>T</code> @see atomic_int for the possible operations \
                 * on this type */                                                                                     \
        ...
        #define P00_DECLARE_ATOMIC2(T, ...)                                                                            \
            ...
            /** @brief Atomic access to a value of type <code>T</code> @see atomic_int for the possible operations on  \
             * this type */                                                                                            \
...
P00_DOCUMENT_IDENTIFIER_ARGUMENT (P99_DECLARE_ATOMIC, 1)
        ...
        #define P00_DECLARE_ATOMIC_CHOICE(MAC, T, NAME)                                                                \
            P99_IF_EQ_2 (MAC)                                                                                          \
            (P99_DECLARE_ATOMIC_LOCK_FREE (T, NAME)) (P99_DECLARE_ATOMIC (T, NAME))
...
P99_DECLARE_ATOMIC (long double _Complex, atomic_cldouble);
            #define P00_ATOMIC_TYPES                                                                                   \
                (_Bool, atomic_bool *), (char, atomic_char *), (signed char, atomic_schar *),                          \
                    (unsigned char, atomic_uchar *), (short int, atomic_short *),                                      \
                    (unsigned short int, atomic_ushort *), (int, atomic_int *), (unsigned int, atomic_uint *),         \
                    (long int, atomic_long *), (unsigned long int, atomic_ulong *), (long long int, atomic_llong *),   \
                    (unsigned long long int, atomic_ullong *), (float, atomic_float *), (double, atomic_double *),     \
                    (long double, atomic_ldouble *), (float _Complex, atomic_cfloat *),                                \
                    (double _Complex, atomic_cdouble *), (long double _Complex, atomic_cldouble *)
        #else
            #define P00_ATOMIC_TYPES                                                                                   \
                (_Bool, atomic_bool *), (char, atomic_char *), (signed char, atomic_schar *),                          \
                    (unsigned char, atomic_uchar *), (short int, atomic_short *),                                      \
        ...
        #define P99_ATOMIC_INHERIT(T)                                                                                  \
            (*P99_GENERIC_LIT (                                                                                        \
                ...
                P99_GENERIC_SIZE_LIT (                                                                                 \
                    sizeof (T) + 1, (struct P99_PASTE3 (p99_atomic_, T, _struct) *) { 0 },                             \
                    (1, union P99_PASTE3 (p99_atomic_, T, _union) *) P99_IF_EQ_2 (ATOMIC_INT8_LOCK_FREE                \
                    ) (, (2, union P99_PASTE3 (p99_atomic_, T, _union) *) ) () P99_IF_EQ_2 (ATOMIC_INT16_LOCK_FREE     \
                    ) (, (3, union P99_PASTE3 (p99_atomic_, T, _union) *) ) () P99_IF_EQ_2 (ATOMIC_INT32_LOCK_FREE     \
                    ) (, (5, union P99_PASTE3 (p99_atomic_, T, _union) *) ) () P99_IF_EQ_2 (ATOMIC_INT64_LOCK_FREE     \
                    ) (, (9, union P99_PASTE3 (p99_atomic_, T, _union) *) ) () P99_IF_EQ_2 (ATOMIC_INT128_LOCK_FREE    \
                    ) (, (17, union P99_PASTE3 (p99_atomic_, T, _union) *) ) ()                                        \
                ),                                                                                                     \
                P00_ATOMIC_TYPES                                                                                       \
            ))

p99_inline P99_CONST_FUNCTION uintptr_t p00_exchange_ignore (void *p00_x, ...) {
    P99_UNUSED (p00_x);
    return 0;
}
        ...
        #define P00_EXCHANGE(X)                                                                                        \
            P99_GENERIC_SIZE (                                                                                         \
                sizeof (X), p00_exchange_ignore, (1, p00_atomic_exchange_1), (2, p00_atomic_exchange_2),               \
                (4, p00_atomic_exchange_4) P99_IF_EQ_2 (ATOMIC_INT64_LOCK_FREE) (, (8, p00_atomic_exchange_8)) ()      \
...
typedef _Atomic (uintmax_t) atomic_uintmax_t;
        ...
        #define atomic_load_explicit(OBJP, ORD)                                                                        \
            p99_extension ({                                                                                           \
                ...
                if (!atomic_is_lock_free (p00_objp)) {                                                                 \
                    ...
                    P99_IF_EMPTY (P99_ATOMIC_LOCK_FREE_TYPES)                                                          \
                    (P00_AT (p00_objp)) (p00_ret.p00_m = p00_atomic_load_n (&P00_AM (p00_objp), (ORD)));               \
                }                                                                                                      \
        ...
        #define atomic_compare_exchange_strong(OBJP, EXPECTED, DESIRED)                                                \
            atomic_compare_exchange_strong_explicit (                                                                  \
                OBJP, EXPECTED, DESIRED, memory_order_seq_cst, memory_order_seq_cst                                    \
            )
                ...
                if (!atomic_is_lock_free (p00_objp)) {                                                                 \
                    P99_SPIN_EXCLUDE (&p00_objp->p00_lock) {                                                           \
                        ...
                        if (p00_ret)                                                                                   \
                            ...
                            *p00_exp = P00_AT (p00_objp);                                                              \
                    }                                                                                                  \
                }                                                                                                      \
                P99_IF_EMPTY (P99_ATOMIC_LOCK_FREE_TYPES)                                                              \
                (else p00_ret = false;) (else p00_ret = p00_atomic_compare_exchange_n (                                \
                                             &P00_AM (p00_objp), ((p00_mbase_t *) p00_exp), p00_des.p00_m, (WEAK),     \
            ...
            #define atomic_store_explicit(OBJP, DES, ORD)                                                              \
                p99_extension ({                                                                                       \
                    ...
                    if (!atomic_is_lock_free (p00_objp)) {                                                             \
                        ...
                        P99_IF_EMPTY (P99_ATOMIC_LOCK_FREE_TYPES)                                                      \
                        (P00_AT (p00_objp)) (p00_atomic_store_n (&P00_AM (p00_objp), p00_des.p00_m, (ORD)));           \
                    }                                                                                                  \
                })
        #endif
        ...
        #define P00_FETCH_OP(OBJP, OPERAND, BUILTIN, OPERATOR, ORD)                                                    \
            p99_extension ({                                                                                           \
                ...
                ((!atomic_is_lock_free (p00_objp))                                                                     \
                     ...
                     : (P99_IF_EMPTY (P99_ATOMIC_LOCK_FREE_TYPES) (P00_AT (p00_objp)) (P00_ATOMIC_TERN (               \
                           p00_objp, BUILTIN (&P00_AO (p00_objp), P00_ATOMIC_TERN (p00_objp, p00_op, 0), (ORD)),       \
                           P00_AT (p00_objp)                                                                           \
                       ))));                                                                                           \
            })
        ...
        #define atomic_fetch_add_conditional(OBJP, OPERAND)                                                            \
            p99_extension ({                                                                                           \
                ...
                while (p00_r) {                                                                                        \
                    ...
                    if (atomic_compare_exchange_weak (p00_objp, &p00_ret, p00_des))                                    \
                        break;                                                                                         \
                    else                                                                                               \
                        p00_r = p00_ret;                                                                               \
                }                                                                                                      \
...
#define atomic_fetch_max_explicit(OBJP, OPERAND, ORD)                                                                  \
    p99_extension ({                                                                                                   \
        ...
        p00_ret                                       = p00_r;                                                         \
        while (p00_r <= p00_op) {                                                                                      \
            if (atomic_compare_exchange_weak (p00_objp, &p00_ret, p00_op))                                             \
                break;                                                                                                 \
            else                                                                                                       \
                p00_r = p00_ret;                                                                                       \
        }                                                                                                              \
