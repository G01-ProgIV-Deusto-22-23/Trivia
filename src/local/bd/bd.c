...
void insertarUsuario(sqlite3 * db, Usuario usuario) {
	...
	char sql[] = "Insert into usuario (ID_Usuario, NombreVisible, Username, Contrasena, AciertosTotales, FallosTotales, ID_Presets) values(?, ?, ?, ?, ?, ?, ?)";
...
void insertarPresets(sqlite3 * db, Presets presets) {
	...
	printf("%i\n", id);
	char sql[] = "Insert into Presets (ID_Presets, nJugadores, nRondas, RoundTime, Categorias, Mecanica1, Mecanica2, Mecanica3, Mecanica4) values(?, ?, ?, ?, ?, ?, ?, ?, ?)";
