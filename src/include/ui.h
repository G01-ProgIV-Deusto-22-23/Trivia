         ...
         ({                                                                                                            \
             ...
             field_attr_t __int_field_fa__ = impl_field_attrs (                                                        \
                 (NARGS (__VA_ARGS__) == 1 || NARGS (__VA_ARGS__) == 3) ? ARG1 (__VA_ARGS__ __VA_OPT__ (, ) 0)         \
                                                                              ...
                                                                              : decplaces (LLONG_MAX)                  \
                 : ARG2 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX)                                             \
                     ? decplaces (ARG2 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX))                             \
                     : decplaces (LLONG_MAX),                                                                          \
                 TYPE_INTEGER                                                                                          \
             );                                                                                                        \
             ...
             if (NARGS (__VA_ARGS__ >= 2)) {                                                                           \
                 ...
                 __int_field_fa__.type_args.integer.max =                                                              \
                     NARGS (__VA_ARGS__) == 2 ? ARG2 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX)                \
                                              : ARG3 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX, LLONG_MAX);    \
             }                                                                                                         \
             __int_field_fa__;                                                                                         \
         }))
#else
             ...
             field_attr_t __int_field_fa__ = impl_field_attrs (                                                        \
                 __builtin_choose_expr (                                                                               \
                     ...
                     __builtin_choose_expr (                                                                           \
                         ...
                         : decplaces (LLONG_MAX),                                                                      \
                     __builtin_choose_expr (                                                                           \
                         isint (ARG2 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX)),                              \
                         ARG2 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX), 0                                    \
                     )                                                                                                 \
                         ? decplaces (ARG2 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX))                         \
                         : decplaces (LLONG_MAX)                                                                       \
                 ),                                                                                                    \
             ...
             __builtin_choose_expr (                                                                                   \
                 ...
                 (__int_field_fa__.type_args.integer.min = __builtin_choose_expr (                                     \
                  ...
                  __int_field_fa__.type_args.integer.max = __builtin_choose_expr (                                     \
                      ...
                      __builtin_choose_expr (                                                                          \
                          isint (ARG2 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX)),                             \
                          ARG2 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX), LLONG_MAX                           \
                      ),                                                                                               \
                      __builtin_choose_expr (                                                                          \
                          isint (ARG3 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX, LLONG_MAX)),                  \
                          ARG3 (__VA_ARGS__ __VA_OPT__ (, ) LLONG_MAX, LLONG_MAX, LLONG_MAX), LLONG_MAX                \
                      )                                                                                                \
                  )),                                                                                                  \
                 (void) 0                                                                                              \
             );                                                                                                        \
             ...
             ({                                                                                                        \
                 ...
                 if (__setup_ui_argc__ <= 1 ||                                                                         \
                     ...
                     if (!strncmp (*__setup_ui_argv__, get_start_server_command (), __setup_ui_cmd_len__)) {           \
                         set_server_port ((int) strtoll ((*(__setup_ui_argv__ + 1)) + __setup_ui_cmd_len__, NULL, 10)  \
                         );                                                                                            \
                         impl_start_server ();                                                                         \
                     } else                                                                                            \
                         game_server (                                                                                 \
                             (size_t) strtoll (__setup_ui_argc__ > 1 ? *(__setup_ui_argv__ + 1) : "", NULL, 10),       \
                             __setup_ui_ret__ =                                                                        \
                                 (int) strtoll (*__setup_ui_argv__ + strlen (get_game_arg ()), NULL, 10),              \
                             (game_attr_t                                                                              \
                             ) { .players    = (uint8_t                                                                \
                                 ) strtoll (__setup_ui_argc__ > 2 ? *(__setup_ui_argv__ + 2) : "", NULL, 10),       \
                                 .round_time = (uint32_t                                                               \
                                 ) strtoll (__setup_ui_argc__ > 4 ? *(__setup_ui_argv__ + 4) : "", NULL, 10),          \
                                 .rounds     = (uint8_t                                                                \
                                 ) strtoll (__setup_ui_argc__ > 3 ? *(__setup_ui_argv__ + 3) : "", NULL, 10) }     \
                         );                                                                                            \
                     _freea (__setup_ui_argv__);                                                                       \
                 }                                                                                                     \
                 _Pragma ("GCC diagnostic pop");                                                                       \
             ...
             ({                                                                                                                                 \
                 ...
                 if (__setup_ui_argc__ <= 1 ||                                                                                                  \
                     ...
                     if (!strncmp (*__setup_ui_argv__, get_start_server_command (), __setup_ui_cmd_len__)) {                                    \
                         ...
                         game_server (                                                                                                          \
                             (size_t) strtoll (__setup_ui_argc__ > 2 ? *(__setup_ui_argv__ + 1) : "", NULL, 10),                                \
                             __setup_ui_ret__ =                                                                                                 \
                                 (int) strtoll (*__setup_ui_argv__ + strlen (get_game_arg ()), NULL, 10),                                       \
                             (game_attr_t                                                                                                       \
                             ) { .players    = (uint8_t                                                                                         \
        ...
        #define setup_ui(...)                                                                                          \
            ({                                                                                                         \
                ...
                if (argc - 1 == 1 && !strncmp (                                                                        \
                    ...
                    set_server_port ((int) strtoll ((*(argv + 1)) + __setup_ui_cmd_len__, NULL, 10));                  \
                    impl_start_server ();                                                                              \
                    exit (0);                                                                                          \
                } else {                                                                                               \
                    stderr_to_null ();                                                                                 \
